...
* ¼öÁ¤ 
*/
function nsMarquee(id, height, width, scrollAmount, scrollDelay, direction, datas)
{
    this.id            = id;
    ...
    var markup = '';
    markup += '<div id="' + this.id + 'container" name="' + this.id + 'container" style="overflow: hidden;  color:#ffffff;';
    if (this.heightUnit != '%')
    {
...
//        this.innerHeight = this.containerDiv.style.height;
//		window.status =  "innerHeight ; " + this.containerDiv.style.height;
        switch (this.direction)
        {
            ...
            case 'up':
                ...
                this.stopAt  = 0;
                this.styleObj[1].top = this.height * 2; // + this.innerHeight;
                break;
...
//            this.styleObj[this.tail].top = this.newPosition + this.styleObj[this.head].height; //this.innerHeight;
            this.styleObj[this.head].top = this.newPosition - this.height;
        ...
        (this.dirsign == -1 && this.newPosition < this.stopAt) )
    {
        ...
        this.newPosition = this.height;//this.newPosition + this.innerHeight;
