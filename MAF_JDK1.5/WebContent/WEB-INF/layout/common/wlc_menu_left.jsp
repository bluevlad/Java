...
%>
    <div id="div_lecinfo"><c:out value="${Lecture.lecname}"/></div>
<%
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr style="cursor:pointer" >
		<td valign="middle" class="menu_l3" 
			onClick="javascript:showMenu('<%=oT.getPgid()%>')" ><%
			if(oT.hasChild()) {
...
%>
<table width="100%" border="0" cellspacing="0" cellpadding="0" ><tr><td><img src='<c:url value="/maf_images/menu/lmenu_sep.gif"/>' width="131" height="1" border="0" /></td></tr></table>
<%			
		}
	}
%>
