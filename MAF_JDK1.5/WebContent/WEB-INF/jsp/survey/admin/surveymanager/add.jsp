...
<script language="javascript">
    ...
    function setChoose(frm_id, elm_id) {
        var urlname = CPATH + "/survey.admin/setchoose.do?frm_id="+frm_id+"&elm_id="+elm_id;
...
<mf:form action="${control_action}" method="post" name="myform" id="myform" onSubmit=" frmSubmit('myform');return false;">
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">
        ...
        <col width="35%" />
        <!--  tr>
            <th nowrap><mf:label name="surveyid" /></th>
            <td colspan="3"><mf:input type="text" name="surveyid" size="50" maxlength="50" value="" /></td>
        </tr-->
        <tr>
        ...
        <tr>
            ...
            <td colspan="3"><mf:input type="text" name="surveydesc" size="100" maxlength="50" value="" /></td>
        </tr>
        <tr>
            <th nowrap><mf:label name="survey_sdat_t1" /></th>
            <td><mf:input type="date" name="survey_sdat_t1" size="10" value="" readonly="true" onclick="popUpCalendar(this, this, 'yyyy-mm-dd');"/></td>
            <th nowrap><mf:label name="survey_edat_t1" /></th>
            <td><mf:input type="date" name="survey_edat_t1" size="10" value="" readonly="true" onclick="popUpCalendar(this, this, 'yyyy-mm-dd');"/></td>
        </tr>
        <tr>
            <th nowrap>Set</th>
            <td colspan="3"><mf:input type="text" name="setid" size="20" maxlength="50" value="" /> 
                <a href="javascript:setChoose('myform','setid')"/>[선택]</a></td>
        </tr>
    </table>
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">
        ...
        <tr>
            <td><mf:input type="checkbox" name="vtarget" value="${target.code_no}"/><mh:out value="${target.code_name}" /></td>
        </tr>
        </c:forEach>
    </table>
