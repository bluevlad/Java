...
function gogogo(form, sel){
    ...
    if(sel==1){ //등록
        if(form.quescore.value==""){
            ...
            alert('<mfmt:message bundle="etest.common" key="script.exm.cat.insert"/>');
            form.cat_name.focus();
            sw = false;
            ...
            if(sw){
                if(form.quetype.value=="<%=Etest.QUE_TYPE_SINGLE%>"){
                    ...
                    form.queviw11.value=form.Squeviw11.value;
                    form.queviw12.value=form.Squeviw12.value;
                    form.queviw13.value=form.Squeviw13.value;
                    form.queviw14.value=form.Squeviw14.value;
                    form.queviw15.value=form.Squeviw15.value;
                    form.queviw16.value=form.Squeviw16.value;
                    form.queviw17.value=form.Squeviw17.value;
                    form.queviw18.value=form.Squeviw18.value;
                    form.queviw19.value=form.Squeviw19.value;
                    form.queviw20.value=form.Squeviw20.value;
                    ...
                    form.queviw11.value=form.Mqueviw11.value;
                    form.queviw12.value=form.Mqueviw12.value;
                    form.queviw13.value=form.Mqueviw13.value;
                    form.queviw14.value=form.Mqueviw14.value;
                    form.queviw15.value=form.Mqueviw15.value;
                    form.queviw16.value=form.Mqueviw16.value;
                    form.queviw17.value=form.Mqueviw17.value;
                    form.queviw18.value=form.Mqueviw18.value;
                    form.queviw19.value=form.Mqueviw19.value;
                    form.queviw20.value=form.Mqueviw20.value;
                }
