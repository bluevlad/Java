		...
		<td align="center" valign="top"><table width="100%" height="484" border="0" cellpadding="0" cellspacing="0">
        	<tr>
				...
				<!--menu start--><table width="450" height="43" border="0" cellpadding="0" cellspacing="0">
                	<tr>
                		<td><img src="${CPATH}/images/msg/icon_01.gif" width="82" height="43"></td>
                		<td><img src="${CPATH}/images/msg/menu_on_01.gif" width="91" height="43"></td>
                		<td><a href="${CPATH}/msgmst/sndlist.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('msg_m02','','${CPATH}/images/msg/menu_on_02.gif',1)"><img src="${CPATH}/images/msg/menu_off_02.gif" name="msg_m02" width="91" height="43" border="0"></a></td>
                		...
                		<td align="center" valign="middle" bgcolor="CCCCCC"><table width="448" height="461" border="0" cellpadding="0" cellspacing="0">
                        	<tr>
                        		<td align="center" valign="middle" bgcolor="F8F8F8"><table width="434" height="387" border="0" cellpadding="0" cellspacing="0">
                        				...
                        				<tr>
                        					<td height="376"><table width="434" height="376" border="0" cellpadding="0" cellspacing="0">
                                            	<tr bgcolor="ACACAC">
                                                            	...
                                                            	<tr align="left" valign="top">
                                                            		<td height="262" colspan="4" class="msg_td">
																		<div style="width: 432px; height: 322px; overflow: auto; solid #898989;">
																			${mhtml:nl2br(msgmstlist.contents)}</div></td>
                                                            	</tr>
                                                            	</table></td>
                                                    		</tr>
                                                    	</table></td>
...
<input type="hidden" name="usn_rcv" value="${msgmstlist.usn_rcv}">
