...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
	<tr>
        <td>
			...
			<input type="hidden" name="${mrt:mvcCmd()}" value="rcvList">
    ...
    <tr>
		...
		<tr onMouseOver="tr_over(this)" onMouseOut="tr_out(this)">
			...
			<td class="list">${mhtml:null2nbsp(item.nm_snd)}</td>
			<td class="list"><a href="javaScript:doView( '${item.msgid}')">${mhtml:null2nbsp(item.title)}</a></td>
