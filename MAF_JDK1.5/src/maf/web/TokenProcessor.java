...
public class TokenProcessor {
    ...
    public synchronized boolean isTokenValid(
        ...
        String saved = (String) session.getAttribute(MiConfig.TRANSACTION_TOKEN_KEY);
        if (saved == null) {
            return false;
        }
        ...
        String token = request.getParameter(MiConfig.TRANSACTION_TOKEN_KEY);
        if (token == null) {
            return false;
        }
    ...
    public synchronized void resetToken(HttpServletRequest request) {
        ...
        session.removeAttribute(MiConfig.TRANSACTION_TOKEN_KEY);
    }
    ...
    public String getTokenName() {
        return MiConfig.TRANSACTION_TOKEN_KEY;
    }
