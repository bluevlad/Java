...
public class HttpHeaderSender {
	private static final String IE_TYPE = "(MSIE 5.0|MSIE 5.1|MSIE 5.5|MSIE 6.0)";
	 ...
	 */
	public static void setDownLoad( HttpServletRequest request, HttpServletResponse response, String fileName, boolean isAttachment, boolean isCache){
