...
function fn_egov_inqire_code() {
	CodeMst.action = "<c:url value='/code/SelectCodeList.do'/>";
	CodeMst.submit();	
}
</script>
</head>
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<a href="<c:url value='/code/SelectCodeList.do' />" class="btn_s" title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a>
