...
<html>
<head>
<title>${pageTitle} <spring:message code="title.list" /></title><!-- 사물함관리 목록 -->
...
function fnSelectList(pageNo){
    ...
    document.listForm.action = "<c:url value='/box/mst/List.do'/>";
...
<div class="board">
	...
	<tr>
		...
		<th class="board_th_link"><spring:message code="box.boxCd" /></th><!-- 사물함코드 -->
		<th class="board_th_link"><spring:message code="box.boxNm" /></th><!-- 사물함명 -->
		<th><spring:message code="box.boxCount" /></th><!-- 총갯수 -->
		<th><spring:message code="box.useNum" /></th><!-- 사용갯수 -->
		<th><spring:message code="box.reqNum" /></th><!-- 예약가능갯수 -->
		<th><spring:message code="box.boxPrice" /></th><!-- 사물함 대여금 -->
		<th><spring:message code="box.deposit" /></th><!-- 사물함 예치금 -->
	</tr>
	</thead>
	<tbody class="ov">
	...
	<tr>
		...
		<td><c:out value="${boxList.boxPrice}"/></td>
		<td><c:out value="${boxList.deposit}"/></td>
	</tr>
	</c:forEach>
	</tbody>
	</table>
