...
function fn_egov_select_linkPage(pageNo){
	...
	document.CodeMstForm.action = "<c:url value='/code/SelectCodeList.do'/>";
...
<form name="CodeMstForm" action="<c:url value='/code/SelectCodeList.do'/>" method="post" onSubmit="fn_egov_search_code(); return false;"> 
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/code/CodeRegist.do' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
