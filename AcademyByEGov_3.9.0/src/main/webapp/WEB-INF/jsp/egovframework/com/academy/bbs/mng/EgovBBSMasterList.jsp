...
function fn_egov_select_linkPage(pageNo){
	...
	document.BBSMasterForm.action = "<c:url value='/bbs/selectBBSMasterInfs.do'/>";
...
function fn_egov_inquire_bbsdetail(bbsId) {
	...
	document.BBSMasterForm.bbsId.value = bbsId;
  	document.BBSMasterForm.action = "<c:url value='/bbs/selectBBSMasterDetail.do'/>";
  	document.BBSMasterForm.submit();
}
</script>
</head>
...
<form name="BBSMasterForm" action="<c:url value='/bbs/selectBBSMasterInfs.do'/>" method="post" onSubmit="fn_egov_search_bbssj(); return false;"> 
<div class="board">
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/bbs/selectBBSMasterDetail.do?bbsId=${resultInfo.bbsId}'/>" onClick="fn_egov_inquire_bbsdetail('<c:out value="${resultInfo.bbsId}"/>');return false;"><c:out value='${fn:substring(resultInfo.bbsNm, 0, 40)}'/></a></td>
