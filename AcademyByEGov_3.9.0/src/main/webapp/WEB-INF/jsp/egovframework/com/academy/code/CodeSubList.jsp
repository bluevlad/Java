...
<c:set var="pageTitle"><spring:message code="comSymCcmCde.CodeDetailVO.title"/></c:set>
<!DOCTYPE html>
<html>
<head>
...
<div class="board">
		...
		<ul>
			<li>
				<select name="searchCondition" title="<spring:message code="title.searchCondition" />">
					...
					<option value="1"  <c:if test="${searchVO.searchCondition == '1'}">selected="selected"</c:if> ><spring:message code="comSymCcmCde.CodeDetailVO.codeId" /></option><!-- 코드ID -->
					<option value="2"  <c:if test="${searchVO.searchCondition == '2'}">selected="selected"</c:if> ><spring:message code="comSymCcmCde.CodeDetailVO.code" /></option><!-- 코드ID -->
					<option value="3"  <c:if test="${searchVO.searchCondition == '3'}">selected="selected"</c:if> ><spring:message code="comSymCcmCde.CodeDetailVO.codeNm" /></option><!-- 코드명 -->
				</select>
			</li>
			<!-- 검색키워드 및 조회버튼 -->
			<li>
	...
	<tr>
		...
		<th><spring:message code="comSymCcmCde.CodeDetailVO.codeId" /></th><!-- 코드ID -->
		<th class="board_th_link"><spring:message code="comSymCcmCde.CodeDetailVO.code" /></th><!-- 코드 -->
		<th><spring:message code="comSymCcmCde.CodeDetailVO.codeNm"/></th><!-- 코드명 -->
		<th><spring:message code="comSymCcmCde.CodeDetailVO.useAt" /></th><!-- 사용여부 -->
	</tr>
	</thead>
	<tbody class="ov">
