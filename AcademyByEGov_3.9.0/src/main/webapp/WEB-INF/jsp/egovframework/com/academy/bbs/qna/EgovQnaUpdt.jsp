...
function fn_egov_inqire_list() {
	qnaVO.action = "<c:url value='/qna/selectQnaList.do'/>";
	qnaVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form commandName="qnaVO" action="${pageContext.request.contextPath}/qna/updateQna.do" method="post" onSubmit="fn_egov_updt_qna(document.forms[0]); return false;">  
<div class="wTableFrm">
