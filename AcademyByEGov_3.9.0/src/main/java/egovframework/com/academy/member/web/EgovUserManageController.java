...
import egovframework.com.academy.member.service.UserManageVO;
...
public class EgovUserManageController {
	...
	@RequestMapping(value = "/member/EgovUserManage.do")
	public String selectUserList(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/member/EgovUserManage";
	}
	 ...
	 * @param model 화면모델
	 * @return member/EgovUserInsert
	 * @throws Exception
	 */
	@RequestMapping("/member/EgovUserInsertView.do")
	public String insertUserView(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, 
		...
		return "egovframework/com/academy/member/EgovUserInsert";
	}
	 ...
	 * @param model 화면모델
	 * @return forward:/member/EgovUserManage.do
	 * @throws Exception
	 */
	@RequestMapping("/member/EgovUserInsert.do")
	 ...
	 * @param model 화면모델
	 * @return member/EgovUserSelectUpdt
	 * @throws Exception
	 */
	@RequestMapping("/member/EgovUserSelectUpdtView.do")
	public String updateUserView(@RequestParam("selectedId") String uniqId, @ModelAttribute("searchVO") UserDefaultVO userSearchVO, Model model) throws Exception {
		...
		return "egovframework/com/academy/member/EgovUserSelectUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/member/EgovUserSelectUpdt.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/member/EgovUserDelete.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/member/EgovIdDplctCnfirmAjax.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/member/EgovUserPasswordUpdt.do")
	public String updatePassword(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("searchVO") UserDefaultVO userSearchVO,
		...
		return "egovframework/com/academy/member/EgovUserPasswordUpdt";
	}
	 ...
	 * @param userSearchVO 검색조건
	 * @param userManageVO 사용자수정정보(비밀번호)
	 * @return member/EgovUserPasswordUpdt
	 * @throws Exception
	 */
	@RequestMapping(value = "/member/EgovUserPasswordUpdtView.do")
