package egovframework.com.academy.menu.service;
...
public class MenuManageVO{
   ...
   private   String   tmpCmd;
	...
	/**
	 * pMenuNo attribute를 리턴한다.
	 * @return int
	 */
	public int getPMenuNo() {
		return pMenuNo;
	}
	/**
	 * pMenuNo attribute 값을 설정한다.
	 * @param pMenuNo int
	 */
	public void setPMenuNo(int pMenuNo) {
