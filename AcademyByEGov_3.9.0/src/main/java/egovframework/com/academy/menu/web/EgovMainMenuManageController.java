...
public class EgovMainMenuManageController {
     ...
     * @exception Exception
     */
    @RequestMapping(value="/menu/EgovMainMenuIndex.do")
    public String selectMainMenuIndex(
        ...
        return "egovframework/com/academy/menu/menu_index";
    }
     ...
     * @exception Exception
     */
    @RequestMapping(value="/menu/EgovMainMenu.do")
     ...
     * @exception Exception
     */
    @RequestMapping(value="/menu/EgovMainMenuHead.do")
     ...
     * @exception Exception
     */
    @RequestMapping(value="/menu/EgovMainMenuLeft.do")
    ...
    @RequestMapping(value="/menu/EgovMainMenuHome.do")
