package egovframework.com.academy.bbs.faq.web;
...
import egovframework.com.academy.bbs.faq.service.EgovFaqService;
import egovframework.com.academy.bbs.faq.service.FaqVO;
...
public class EgovFaqController {
	...
	public String selectFaqList(@ModelAttribute("searchVO") FaqVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/faq/EgovFaqList";
	}
	 ...
	 * @param searchVO
	 * @param model
	 * @return	"/faq/EgovFaqDetail"
	 * @throws Exception
	 */
	@RequestMapping("/faq/selectFaqDetail.do")
	public String selectFaqDetail(FaqVO faqVO, @ModelAttribute("searchVO") FaqVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/faq/EgovFaqDetail";
	}
	 ...
	 * @param searchVO
	 * @param model
	 * @return	"/faq/EgovFaqRegist"
	 * @throws Exception
	 */
	@RequestMapping("/faq/insertFaqView.do")
	 ...
	 * @param faqVO
	 * @param bindingResult
	 * @return	"forward:/faq/selectFaqList.do"
	 * @throws Exception
	 */
	...
	public String updateFaqView(@RequestParam("faqId") String faqId, @ModelAttribute("searchVO") FaqVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/faq/EgovFaqUpdt";
	}
