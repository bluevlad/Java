package egovframework.com.academy.bbs.mng.web;
...
public class EgovBBSMasterController {
    ...
    @RequestMapping("/bbs/selectBBSMasterInfs.do")
    public String selectBBSMasterInfs(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/mng/EgovBBSMasterList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/bbs/insertBBSMasterView.do")
    public String insertBBSMasterView(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/mng/EgovBBSMasterRegist";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/bbs/insertBBSMaster.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/bbs/selectBBSMasterDetail.do")
    public String selectBBSMasterDetail(@ModelAttribute("searchVO") BoardMasterVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/mng/EgovBBSMasterDetail";
    }
    ...
    public String updateBBSMasterView(@RequestParam("bbsId") String bbsId, @ModelAttribute("searchVO") BoardMaster searchVO, ModelMap model) throws Exception {
        ...
        return "egovframework/com/academy/bbs/mng/EgovBBSMasterUpdt";
    }
    ...
    public String selectBBSListPortlet(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/com/academy/bbs/mng/EgovBBSListPortlet";
    }
