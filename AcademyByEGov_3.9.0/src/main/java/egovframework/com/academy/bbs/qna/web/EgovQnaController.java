package egovframework.com.academy.bbs.qna.web;
...
import egovframework.com.academy.bbs.qna.service.EgovQnaService;
import egovframework.com.academy.bbs.qna.service.QnaDefaultVO;
import egovframework.com.academy.bbs.qna.service.QnaVO;
...
public class EgovQnaController {
	...
	public String selectQnaList(@ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/qna/EgovQnaList";
	}
...
//		vo.setWritngPassword(EgovFileScrty.decode(writngPassword));
		...
		return "egovframework/com/academy/bbs/qna/EgovQnaDetail";
	}
	 ...
	 * @param qnaManageVO
	 * @param model
	 * @return	"/qna/EgovQnaRegist"
	 * @throws Exception
	 */
	@RequestMapping("/qna/insertQnaView.do")
	public String insertQnaView(@ModelAttribute("searchVO") QnaVO searchVO, QnaVO qnaVO, Model model) throws Exception {
		...
		if (!isAuthenticated) {
			...
			return "egovframework/com/academy/bbs/qna/EgovQnaRegist";
		}
	 ...
	 * @param qnaVO
	 * @param bindingResult
	 * @return	"forward:/qna/selectQnaList.do"
	 * @throws Exception
	 */
	@SuppressWarnings("deprecation")
...
//		qnaVO.setWritngPassword(EgovFileScrty.encode(writngPassword));
	 ...
	 * @param searchVO
	 * @param model
	 * @return	"/qna/EgovQnaUpdt
	 * @throws Exception
	 */
	@SuppressWarnings("deprecation")
	@RequestMapping("/qna/updateQnaView.do")
...
//		vo.setWritngPassword(EgovFileScrty.decode(writngPassword));
		...
		return "egovframework/com/academy/bbs/qna/EgovQnaUpdt";
	}
...
//		qnaManageVO.setWritngPassword(EgovFileScrty.encode(writngPassword));
	 ...
	 * @param searchVO
	 * @param model
	 * @return	"/qna/EgovQnaAnswerList"
	 * @throws Exception
	 */
	@IncludedInfo(name = "Q&A답변관리", order = 551, gid = 50)
	@RequestMapping(value = "/qna/selectQnaAnswerList.do")
	public String selectQnaAnswerList(@ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/qna/EgovQnaAnswerList";
	}
	 ...
	 * @param searchVO
	 * @param model
	 * @return	"/qna/EgovQnaAnswerDetail"
	 * @throws Exception
	 */
	@RequestMapping("/qna/selectQnaAnswerDetail.do")
	public String selectQnaAnswerDetail(QnaVO qnaVO, @ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/qna/EgovQnaAnswerDetail";
	}
	 ...
	 * @param searchVO
	 * @param model
	 * @return	"/qna/EgovQnaAnswerUpdt"
	 * @throws Exception
	 */
	@RequestMapping("/qna/updateQnaAnswerView.do")
	public String updateQnaAnswerView(QnaVO qnaVO, @ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "egovframework/com/academy/bbs/qna/EgovQnaAnswerUpdt";
	}
	 ...
	 * @param qnaVO
	 * @param searchVO
	 * @return	"forward:/qnm/selectQnaAnswerList.do"
	 * @throws Exception
	 */
	@RequestMapping("/qna/updateQnaAnswer.do")
	public String updateQnaAnswer(QnaVO qnaVO, @ModelAttribute("searchVO") QnaVO searchVO) throws Exception {
		...
		return "forward:/qna/selectQnaAnswerList.do";
