    ...
    <table class="table01">
        ...
        <tr>
            ...
            <td scope="col" style="text-align:left;">
                ...
                <select name="MOCKCODE" id="MOCKCODE">
                  <c:forEach items="${exmList}"  var="data" varStatus="status" >
                    <option value="${data.MOCKCODE}">${data.MOCKNAME}</option>
                  </c:forEach>
                </select>
                </div>
            </td>
        ...
        <tr>
            ...
            <td scope="col" style="text-align:left;">
                <div class="item">
                    <input type="text" id="SUBJECT" name="SUBJECT" class="i_text" title="제목" value="" style="width:68%;" />&nbsp;&nbsp;
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                    <textarea id="CONTENT" name="CONTENT" cols="50" rows="20" class="i_text" title="내용" style="width:96%;"></textarea>
                </div>
            </td>
        </tr>
        <tr>
...
function deleteAttachFile(id){
    $.ajax({
        type: "GET", 
        url: '<c:url value="/mtboard/deleteFile/"/>'+id,
        dataType: "json",       
        async : false,
...
function paramCheck() {
    ...
    if(codeStr==""){
        ...
        $("#frm").attr("action", "<c:url value='/mtboard/boardInsertProcess.do' />");
        $("#frm").submit();
    }
}
