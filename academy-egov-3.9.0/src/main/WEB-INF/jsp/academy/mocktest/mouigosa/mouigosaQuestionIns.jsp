    ...
    <c:if test="${searchMap.QUESTIONREGISTRATIONOPTION == '1' || searchMap.QUESTIONREGISTRATIONOPTION == '2' }">
      ...
      <c:if test="${searchMap.QUESTIONFILEID ne null }">
        <tr>
            ...
            <td style="text-align:left;"><div class="item">
                <c:choose>
                    <c:when test="${searchMap.QUESTIONFILEID != ''}"><img src="<c:url value="http://file3.willbes.net/${searchMap.QUESTIONFILEPATH }" />" /></c:when>
      ...
      <c:if test="${searchMap.ANSWEREXPLAINFILEID ne null }">
        <tr>
            ...
            <td style="text-align:left;"><div class="item">
                <c:choose>
                    <c:when test="${searchMap.ANSWEREXPLAINFILEID != ''}"><img src="<c:url value="http://file3.willbes.net/${searchMap.ANSWEREXPLAINFILEPATH }" />" /></c:when>
