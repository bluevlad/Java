...
var MOCKCODE = "${params.MOCKCODE}";
var EXAMPERIOD = "${params.EXAMPERIOD}";
...
function getSubCODE(selectId, target, url, sts) {
    ...
    var CLASSSERIESCODE = "${params.CLASSSERIESCODE}";
...
<form id="popFrm" name="popFrm" method="post">
    ...
    <input type="hidden" id="S_EXAMYEAR" name="S_EXAMYEAR" value="${params.S_EXAMYEAR}">
    <input type="hidden" id="S_EXAMROUND" name="S_EXAMROUND" value="${params.S_EXAMROUND}">
    <input type="hidden" id="S_ISEXAMTYPEON" name="S_ISEXAMTYPEON" value="${params.S_ISEXAMTYPEON}">
    <input type="hidden" id="S_ISEXAMTYPEOFF" name="S_ISEXAMTYPEOFF" value="${params.S_ISEXAMTYPEOFF}">
    <input type="hidden" id="S_CLASSCODE" name="S_CLASSCODE" value="${params.S_CLASSCODE}">

<div id="content">
    <h2>
    <c:choose>
        <c:when test="${sts == 'I' }">● ${L_MENU_NM} > <strong>${MENU_NM} - 등록</strong></c:when>
        <c:when test="${sts == 'U' }">● ${L_MENU_NM} > <strong>${MENU_NM} - 수정</strong></c:when>
    </c:choose>
    </h2>
    ...
    <table class="table01">
        ...
        <tr>
            ...
            <td>
                <div class="item">
                제목:
                <input id="MOCKNAME" name="MOCKNAME" type="text" class="i_text must" style="width:320px;" title="모의고사 명을 입력해 주세요" value="${params.MOCKNAME}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                년도:
                <select id="EXAMYEAR" name="EXAMYEAR" class="must" >
                    <option value="2013"  <c:if test="${params.EXAMYEAR == '2013'}">selected</c:if>>2013</option>
                    <option value="2014"  <c:if test="${params.EXAMYEAR == '2014'}">selected</c:if>>2014</option>
                    <option value="2015"  <c:if test="${params.EXAMYEAR == '2015'}">selected</c:if>>2015</option>
                    <option value="2016"  <c:if test="${params.EXAMYEAR == '2016'}">selected</c:if>>2016</option>
                    <option value="2017"  <c:if test="${params.EXAMYEAR == '2017'}">selected</c:if>>2017</option>
                    <option value="2018"  <c:if test="${params.EXAMYEAR == '2018'}">selected</c:if>>2018</option>
                    <option value="2019"  <c:if test="${params.EXAMYEAR == '2019'}">selected</c:if>>2019</option>
                </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      회차:
                <select id="EXAMROUND" name="EXAMROUND" class="must" >
                    <option value="1"  <c:if test="${params.EXAMROUND == '1'}">selected</c:if>>1</option>
                    <option value="2"  <c:if test="${params.EXAMROUND == '2'}">selected</c:if>>2</option>
                    <option value="3"  <c:if test="${params.EXAMROUND == '3'}">selected</c:if>>3</option>
                    <option value="4"  <c:if test="${params.EXAMROUND == '4'}">selected</c:if>>4</option>
                    <option value="5"  <c:if test="${params.EXAMROUND == '5'}">selected</c:if>>5</option>
                    <option value="6"  <c:if test="${params.EXAMROUND == '6'}">selected</c:if>>6</option>
                    <option value="7"  <c:if test="${params.EXAMROUND == '7'}">selected</c:if>>7</option>
                    <option value="8"  <c:if test="${params.EXAMROUND == '8'}">selected</c:if>>8</option>
                    <option value="9"  <c:if test="${params.EXAMROUND == '9'}">selected</c:if>>9</option>
                    <option value="10"  <c:if test="${params.EXAMROUND == '10'}">selected</c:if>>10</option>
                    <option value="11"  <c:if test="${params.EXAMROUND == '11'}">selected</c:if>>11</option>
                    <option value="12"  <c:if test="${params.EXAMROUND == '12'}">selected</c:if>>12</option>
                    <option value="13"  <c:if test="${params.EXAMROUND == '13'}">selected</c:if>>13</option>
                    <option value="14"  <c:if test="${params.EXAMROUND == '14'}">selected</c:if>>14</option>
                    <option value="15"  <c:if test="${params.EXAMROUND == '15'}">selected</c:if>>15</option>
                    <option value="16"  <c:if test="${params.EXAMROUND == '16'}">selected</c:if>>16</option>
                    <option value="17"  <c:if test="${params.EXAMROUND == '17'}">selected</c:if>>17</option>
                    <option value="18"  <c:if test="${params.EXAMROUND == '18'}">selected</c:if>>18</option>
                    <option value="19"  <c:if test="${params.EXAMROUND == '19'}">selected</c:if>>19</option>
                    <option value="20"  <c:if test="${params.EXAMROUND == '20'}">selected</c:if>>20</option>
                    <option value="21"  <c:if test="${params.EXAMROUND == '21'}">selected</c:if>>21</option>
                    <option value="22"  <c:if test="${params.EXAMROUND == '22'}">selected</c:if>>22</option>
                    <option value="23"  <c:if test="${params.EXAMROUND == '23'}">selected</c:if>>23</option>
                    <option value="24"  <c:if test="${params.EXAMROUND == '24'}">selected</c:if>>24</option>
                    <option value="25"  <c:if test="${params.EXAMROUND == '25'}">selected</c:if>>25</option>
                    <option value="26"  <c:if test="${params.EXAMROUND == '26'}">selected</c:if>>26</option>
                    <option value="27"  <c:if test="${params.EXAMROUND == '27'}">selected</c:if>>27</option>
                    <option value="28"  <c:if test="${params.EXAMROUND == '28'}">selected</c:if>>28</option>
                    <option value="29"  <c:if test="${params.EXAMROUND == '29'}">selected</c:if>>29</option>
                    <option value="30"  <c:if test="${params.EXAMROUND == '30'}">selected</c:if>>30</option>
                </select>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                <input id="ISEXAMTYPEON" name="ISEXAMTYPEON" class="i_checkbox" value="2" type="checkbox" <c:if test="${params.ISEXAMTYPEON == '1' }">checked="checked"</c:if> onclick="chkbox()"/><label for="ISEXAMTYPEON">&nbsp;&nbsp;ON</label>
                <input id="ISEXAMTYPEOFF" name="ISEXAMTYPEOFF" class="i_checkbox" value="2" type="checkbox" <c:if test="${params.ISEXAMTYPEOFF == '1' }">checked="checked"</c:if> onclick="chkbox()"/><label for="ISEXAMTYPEOFF">&nbsp;&nbsp;OFF</label>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <th>마감인원(OFF)</th>
            <td style="text-align:left;">
                <div class="item"><input id="OFFCLOSEPERSONNUMBER" name="OFFCLOSEPERSONNUMBER" type="text" class="i_text" style="width:4%;" maxlength="4" value="${params.OFFCLOSEPERSONNUMBER}" onkeyup="chk(this,'OFFCLOSEPERSONNUMBER')" onblur="chk(this,'OFFCLOSEPERSONNUMBER')"/></div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                    <input id="EXAMSTARTTIME1" name="EXAMSTARTTIME1" type="text" maxlength="10" class="i_text" <c:if test="${!empty params.EXAMSTARTTIME}">value="${fn:substring(params.EXAMSTARTTIME, 0, 4)}-${fn:substring(params.EXAMSTARTTIME, 4, 6)}-${fn:substring(params.EXAMSTARTTIME, 6, 8)}"</c:if> readonly="readonly" style="width:90px;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);"/>
                    <input id="EXAMSTARTTIME2" name="EXAMSTARTTIME2" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.EXAMSTARTTIME, 8, 10)}" onkeyup="chk(this,'EXAMSTARTTIME2')" onblur="chk(this,'EXAMSTARTTIME2')"/>시
                    <input id="EXAMSTARTTIME3" name="EXAMSTARTTIME3" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.EXAMSTARTTIME, 10, 12)}" onkeyup="chk(this,'EXAMSTARTTIME3')" onblur="chk(this,'EXAMSTARTTIME3')"/>분~

                    <input id="EXAMENDTIME1" name="EXAMENDTIME1" type="text" maxlength="10" class="i_text" <c:if test="${!empty params.EXAMENDTIME}">value="${fn:substring(params.EXAMENDTIME, 0, 4)}-${fn:substring(params.EXAMENDTIME, 4, 6)}-${fn:substring(params.EXAMENDTIME, 6, 8)}"</c:if> readonly="readonly" style="width:90px;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);"/>
                    <input id="EXAMENDTIME2" name="EXAMENDTIME2" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.EXAMENDTIME, 8, 10)}" onkeyup="chk(this,'EXAMENDTIME2')" onblur="chk(this,'EXAMENDTIME2')"/>시
                    <input id="EXAMENDTIME3" name="EXAMENDTIME3" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.EXAMENDTIME, 10, 12)}" onkeyup="chk(this,'EXAMENDTIME3')" onblur="chk(this,'EXAMENDTIME3')"/>분
                    &nbsp;
                    <input name="EXAMPERIODTYPE" id="EXAMPERIODTYPE1" class="i_radio" value="0" type="radio" <c:if test="${empty params.EXAMPERIODTYPE or params.EXAMPERIODTYPE == '0' }">checked="checked"</c:if> /><label for="EXAMPERIODTYPE1">사용선택</label>
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                <input id="EXAMPERIOD" name="EXAMPERIOD" type="text" class="i_text" style="width:3%;" maxlength="3" value="${params.EXAMPERIOD}" onkeyup="chk(this,'EXAMPERIOD')" onblur="chk(this,'EXAMPERIOD')"/>일
                &nbsp;
                <input name="EXAMPERIODTYPE" id="EXAMPERIODTYPE2" class="i_radio" value="1" type="radio" <c:if test="${params.EXAMPERIODTYPE == '1' }">checked="checked"</c:if> /><label for="EXAMPERIODTYPE2">사용선택</label>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <th>시험응시시간</th>
            <td style="text-align:left;">
                <div class="item"><input id="EXAMTIME" name="EXAMTIME" type="text" alt="시험시간" class="i_text must number" style="width:3%;" maxlength="3" title="시험응시시간을 입력해 주세요" value="${params.EXAMTIME}" onkeyup="chk(this,'EXAMTIME')" onblur="chk(this,'EXAMTIME')"/>분</div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                    <input id="RECEIPTSTARTTIME1" name="RECEIPTSTARTTIME1" type="text" maxlength="10" class="i_text" <c:if test="${!empty params.RECEIPTSTARTTIME}">value="${fn:substring(params.RECEIPTSTARTTIME, 0, 4)}-${fn:substring(params.RECEIPTSTARTTIME, 4, 6)}-${fn:substring(params.RECEIPTSTARTTIME, 6, 8)}"</c:if> readonly="readonly" style="width:90px;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);"/>
                    <input id="RECEIPTSTARTTIME2" name="RECEIPTSTARTTIME2" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.RECEIPTSTARTTIME, 8, 10)}" onkeyup="chk(this,'RECEIPTSTARTTIME2')" onblur="chk(this,'RECEIPTSTARTTIME2')"/>시
                    <input id="RECEIPTSTARTTIME3" name="RECEIPTSTARTTIME3" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.RECEIPTSTARTTIME, 10, 12)}" onkeyup="chk(this,'RECEIPTSTARTTIME3')" onblur="chk(this,'RECEIPTSTARTTIME3')"/>분~

                    <input id="RECEIPTENDTIME1" name="RECEIPTENDTIME1" type="text" maxlength="10" class="i_text" <c:if test="${!empty params.RECEIPTENDTIME}">value="${fn:substring(params.RECEIPTENDTIME, 0, 4)}-${fn:substring(params.RECEIPTENDTIME, 4, 6)}-${fn:substring(params.RECEIPTENDTIME, 6, 8)}"</c:if> readonly="readonly" style="width:90px;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);"/>
                    <input id="RECEIPTENDTIME2" name="RECEIPTENDTIME2" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.RECEIPTENDTIME, 8, 10)}" onkeyup="chk(this,'RECEIPTENDTIME2')" onblur="chk(this,'RECEIPTENDTIME2')"/>시
                    <input id="RECEIPTENDTIME3" name="RECEIPTENDTIME3" type="text" class="i_text" style="width:2%;" maxlength="2" value="${fn:substring(params.RECEIPTENDTIME, 10, 12)}" onkeyup="chk(this,'RECEIPTENDTIME3')" onblur="chk(this,'RECEIPTENDTIME3')"/>분
                </div>
            </td>
        </tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                    ...
                    <c:forEach items="${registration_list}"  var="registration_list">
                        <option value="${registration_list.CODE }" <c:if test="${params.CLASSCODE == registration_list.CODE}">selected</c:if>>${registration_list.NAME }</option>
                    </c:forEach>
                    </select>
                </div>
                <!--테이블-->
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                    <input id="EXAMCOST" name="EXAMCOST" type="text" alt="응시료 원가"  class="i_text must number" maxlength="7" title="응시료 원가를 입력해 주세요." value="${params.EXAMCOST }" style="width:50px;" />원가&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input id="DISCOUNTRATIO" name="DISCOUNTRATIO" type="text" alt="응시료 할인율"  class="i_text must number" maxlength="3" title="응시료 할인율을 입력해 주세요." value="${params.DISCOUNTRATIO }" style="width:40px;" />할인율(%)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input id="SALEAMOUNTS" name="SALEAMOUNTS" type="text" alt="응시료 판매가"  class="i_text must number" maxlength="7" title="응시료 판매가를 입력해 주세요." value="${params.SALEAMOUNTS }" style="width:50px;" />판매가
                </div>
            </td>
        </tr>
            ...
            <td style="text-align:left;">
                <div class="item">
                    <select id="USEFLAG" name="USEFLAG" class="must">
                        <option value="1"  <c:if test="${params.USEFLAG == '1'}">selected</c:if>>활성</option>
                        <option value="0"  <c:if test="${params.USEFLAG == '0'}">selected</c:if>>비활성</option>
                        <option value="3"  <c:if test="${params.USEFLAG == '3'}">selected</c:if>>상시</option>
                        <option value="2"  <c:if test="${params.USEFLAG == '2'}">selected</c:if>>마감</option>
                    </select>
                </div>
            </td>
        </tr>
