...
<%--         <c:forEach items="${formlist}" var="item" varStatus="loop">
  ...
  <table class="table01">
    ...
    <tr>
          ...
          <td><input type="text" id="SUBJECT_WIDE_DEFAULT_PATH" name="SUBJECT_WIDE_DEFAULT_PATH" value="http://hd3.willbes.gscdn.com/" size="100" class="txt05" maxlength="400"/></td>
...
<!--     <tr>
        ...
        <tr>
          ...
          <td><input type="text" id="SUBJECT_MP4_DEFAULT_PATH" name="SUBJECT_MP4_DEFAULT_PATH" value="http://hd3.willbes.gscdn.com/" size="100" class="txt06" maxlength="400"/></td>
        </tr>
        <tr>
