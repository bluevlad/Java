...
<input type="hidden" id="BRIDGE_LECS_STR" name=BRIDGE_LECS_STR value="${params.BRIDGE_LECS_STR}"/>
...
function fn_excel() { //ck 추가 
	$('#frm').attr('action','<c:url value="/lectureOff/selpayList_excel.do"/>').submit();
}
</script>
</body>
</html>