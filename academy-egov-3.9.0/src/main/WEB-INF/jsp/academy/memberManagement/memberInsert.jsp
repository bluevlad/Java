...
<input type="hidden" name="SBJ_REQ" id="SBJ_REQ" value="" />
<input type="hidden" name="F_CAT_CD" id="F_CAT_CD" value="" />
<input type="hidden" name="F_AREA" id="F_AREA" value="" />
<input type="hidden" name="S_CAT_CD" id="S_CAT_CD" value="" />
<input type="hidden" name="S_AREA" id="S_AREA" value="" />
<input type="hidden" id="EVENT_REQ" name="EVENT_REQ" value="" />
<input type="hidden" name="SBJ_REQ_COUNT" id="SBJ_REQ_COUNT" value="0" />
    ...
    <h2>● 회원관리 > <strong>회원조회</strong></h2> 
        ...
        <tr>
            <th>핸드폰</th>
            <td>
                <input type="text" id="PHONE_NO" name="PHONE_NO" value="" size="20"  maxlength="20" title="핸드폰" style="width:50%;ime-mode:disabled;" onKeyDown="fn_OnlyNumber(this);"/>
            </td>
            <th>자택전화번호</th>
            <td>
                <input type="text" id="TEL_NO" name="TEL_NO" value="" size="20"  maxlength="20" title="전화번호" style="width:50%;ime-mode:disabled;" onKeyDown="fn_OnlyNumber(this);"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <c:forEach items="${JOIN_CHANNELs}" var="data" varStatus="status" >
                    <option value="${data.CODE_CD}"><c:out value='${data.CODE_NM}'/></option>
                </c:forEach>
                </select>
            </td>
            <th>직업</th>
        ...
        <tr>
            ...
            <td>
                ...
                <c:forEach items="${categoryList}" var="data" varStatus="status" >
                    <option value="${data.CODE}"><c:out value='${data.NAME}'/></option>
                </c:forEach>
                </select>
            </td>
            <th>수험기간</th>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <c:forEach items="${AREAs}" var="data" varStatus="status" >
                    <input type="checkbox" id="f_area_${data.CODE_CD}" name="f_area_${data.CODE_CD}" value="${data.CODE_CD}" onchange="javascript:fn_f_area(this)"><label for="f_area_${data.CODE_CD}"><c:out value='${data.CODE_NM}'/></label>&nbsp;
                </c:forEach>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                ...
                <ul class="iptList">
                <c:forEach items="${AREAs}" var="data" varStatus="status" >
                    <input type="checkbox" id="s_area_${data.CODE_CD}" name="s_area_${data.CODE_CD}" value="${data.CODE_CD}" onchange="javascript:fn_s_area(this)"><label for="s_area_${data.CODE_CD}"><c:out value='${data.CODE_NM}'/></label>&nbsp;
                </c:forEach>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <div id="event_req_etc" style="display: none">
                    <div class="elts"><label for="elts">기타 :</label><input type="text" class="ipt" id="event_req_etc_txt" name="event_req_etc_txt"  value=""></div>
                </div>
            </td>
        </tr>
        <tr>
...
function fn_f_area(obj){
    ...
    if(document.getElementById("f_area_"+obj.value).checked){
        ...
        if(parseInt($("#F_AREA").val().length) == 2){
            var y = $("#F_AREA").val().replace(document.getElementById("f_area_"+obj.value).value,"");
        }else{
...
function fn_s_area(obj){
    ...
    if(document.getElementById("s_area_"+obj.value).checked){
        ...
        if(parseInt($("#S_AREA").val().length) == 2){
            var y = $("#S_AREA").val().replace(document.getElementById("s_area_"+obj.value).value,"");
        }else{
