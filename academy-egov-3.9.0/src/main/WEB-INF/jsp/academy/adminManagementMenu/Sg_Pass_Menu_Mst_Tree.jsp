        ...
        <div class="dtree">
            ...
            <script type="text/javascript">
                ...
                function menuUpdate(menu_id){
                    $(parent.document).find("#frmMenuEdit").attr("src" , '<c:url value="/adminManagementMenu/passmenuDetail.frm"/>?MENU_ID='+menu_id+'&TOP_MENU_ID=${TOP_MENU_ID}&MENUTYPE=${MENUTYPE}');
                }   
