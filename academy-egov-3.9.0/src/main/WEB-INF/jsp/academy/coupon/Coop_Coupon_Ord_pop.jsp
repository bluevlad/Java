...
function goList(page) {
	...
	$("#frm").attr("action", "<c:url value='/Coupon/coop_coupon_ord.pop' />");
	$("#frm").submit();
}
...
function view(userid){
	if(userid=="" || userid ==null){
		...
		window.open('<c:url value="/productOrder/MemberView1.pop"/>?userid=' + userid, '_user', 'location=no,resizable=no,width=800,height=630,top=0,left=0,scrollbars=no,location=no,scrollbars=yes');
	}
}
</script>
</body>
