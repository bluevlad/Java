...
<div id="content">
	...
	<table class="table01">
		...
		<tr>
        	<th>사용여부</th>
        	<td>
        		<input type="radio" name="ISUSE" value="Y"  <c:if test="${view.IS_SHOW == 'Y' }">checked="checked"</c:if>><span class="txt03">활성</span>
          		<input type="radio" name="ISUSE" value="N"  <c:if test="${view.IS_SHOW == 'N' }">checked="checked"</c:if>><span class="txt04">비활성</span>
          	</td>
      </tr>
    </table>
