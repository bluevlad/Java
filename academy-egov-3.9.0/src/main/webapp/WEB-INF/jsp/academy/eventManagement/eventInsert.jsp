...
<table class="table01">
	...
	<tr>
		<th>시작종료일시</th>
		<td colspan="3" class="tdLeft">
			<input type="text" id="START_DATE" name="START_DATE" style="width:60px;">
			...
			시
			&nbsp;&nbsp;~&nbsp;
			<input type="text" id="END_DATE" name="END_DATE" style="width:60px;">
...
<table class="table01">
	<tr>
		<th width="20%">
			<input type="radio" id="CONTNT_GUBUN" name="CONTNT_GUBUN" value="IMG" checked="checked" onclick="javascript:contntEvent();"/><br/>이미지
		</th>
		<td class="tdLeft"><input type="file" name="CONTENTS_IMG" id="CONTENTS_IMG" style="width:500px;">
		</td>
	</tr>
	<tr>
		<th width="10%">
			<input type="radio" id="CONTNT_GUBUN" name="CONTNT_GUBUN" value="EDTR" onclick="javascript:contntEvent();"/><br/>에디터
		</th>
		<td class="tdLeft">
...
<table class="table01">
	<tr>
		...
		<td class="tdLeft"><input type="file" name="LIST_THUMBNAIL" id="LIST_THUMBNAIL" style="width:500px;"></td>
	</tr>
	<tr>
		<th>이슈 썸네일</th>
		<td class="tdLeft"><input type="file" name="ISSUE_THUMBNAIL" id="ISSUE_THUMBNAIL"  style="width:500px;"></td>
	</tr>
 </table>

<br/>
● 옵션 1 <input type="checkbox" id="OPTION1" name="OPTION1" value="Y" onclick="javascript:fn_Display();"/> (선택시 노출)
<table class="table01" id="option1Table" style="display: none;">
	<tr>
		<th width="20%">선택리스트</th>
		<td class="tdLeft tdValign">
			* 1개라도 옵션리스트 설정시 정보입력(이름, 연락, 이메일) 자동 생성<br/>
			...
			<div id="listControl"></div>
		</td>
	</tr>
	<tr>
		<th>선택 방식 설정</th>
		<td class="tdLeft tdValign"><input type="checkbox" id="MULTI_SELECT_YN" name="MULTI_SELECT_YN" value="Y"/>다중선택</td>
	</tr>
</table>

<br/>
<!--//테이블--> 
● 옵션 2 <input type="checkbox" id="OPTION2" name="OPTION2" value="Y" onclick="javascript:fn_Display();"/> (선택시 노출)
<table class="table01" id="option2Table" style="display: none;">
	<tr>
		<th width="20%">덧글기능 선택</th>
		<td class="tdLeft tdValign">선택시 이벤트 내용 하단에 댓글 기능 노출</td>
	</tr>
	<tr>
		<th>덧글 비노출 설정</th>
		<td class="tdLeft tdValign"><input type="checkbox" id="OPTION2_HIDDEN" name="OPTION2_HIDDEN" value="N" />비노출</td>
	</tr>
</table>
<c:if test="${MENUTYPE eq 'FM_ROOT'}">
<br/>
	...
	<table class="table01" id="option3Table" style="display: none;">
	      <tr>
			...
			<td width="80%">
				...
				<br><br><br><br>
				[발신번호] <input type="text" name="SMSNUM" value="1544-6219" >				
			</td>
	      </tr>
	</table>	
</c:if>	
