...
<input type="hidden" id="L_MENU_NM" name="L_MENU_NM" value="${L_MENU_NM}" /> 
	...
	<h2>● 회원관리 > 관리자조회 > <strong>관리자 상세</strong></h2>	
    	<table class="table01">
   		<tr>
   			<th>회원ID</th>
  			<td>
   		...
   		<tr>
   			<th>성명</th>
  			<td>
	   			<!-- 본명 :  --><input type="text" id="USER_NM" name="USER_NM" value="${detail.USER_NM}" size="20"  maxlength="25" title="성명" style="width:28%;background:#FFECEC;"/>
  			</td>
  		</tr>  		
   		<tr>
   			<th>별명</th>
