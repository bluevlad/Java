        ...
        <tr>
            ...
            <td scope="col" style="text-align:left;">
                ...
                <select id="EXAMYEAR" name="EXAMYEAR" class="must">
	                ...
	                <option value="${i}" <c:if test="${searchMap.EXAMYEAR == i}">selected</c:if>><c:out value="${i}"/></option>
					</c:forEach>
                   </select>
                   /
                   <select id="EXAMROUND" name="EXAMROUND" class="must">
	                <c:forEach var="i" begin="1" end="30" step="1">
	                <option value="${i}" <c:if test="${searchMap.EXAMROUND == i}">selected</c:if>><c:out value="${i}"/></option>
					</c:forEach>
                   </select>
                </div>
            </td>
    ...
    <table class="table02">
      ...
      <c:if test="${not empty list}">
        ...
        <tr>
            ...
            <td>
            <c:if test="${list.QUESTIONNUMBER eq null}"><span class="btn_pack small"><button type="button" onclick="addPopup('${list.ITEMID}','${list.QUESTIONNUMBER}')">등록</button></span></c:if>
            <c:if test="${list.QUESTIONNUMBER ne null}"><span class="btn_pack small"><button type="button" onclick="editPopup('${list.ITEMID}','${list.QUESTIONNUMBER}')">수정</button></span></c:if>
            </td>
