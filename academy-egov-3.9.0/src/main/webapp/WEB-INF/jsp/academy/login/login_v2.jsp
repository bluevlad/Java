...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success : function(data, textStatus, jqXHR) {
                    if(data=="Y"){
                        ...
                        alert("해당하는 관리자 전화번호가 누락됬습니다. 전화번 입력을 먼저해주세요.");
                        return;
                    } else if(data =="N"){
    ...
    function fn_sms(){
    	...
    	var pswd = $('#PSWD').val();
       	window.open('<c:url value="/login/loginSMS"/>?USERID='+user_id+'&PSWD='+pswd, '_loginFrm', 'location=no,resizable=yes,width=400,height=200,top=0,left=0,scrollbars=yes,location=no');
    }
...
<div class="admWrap">
    <div class="admInner">
        <div class="admHeader"><h1><img src="<c:url value='/resources/img/adm_logo.png'/>" alt="윌비스경찰학원 관리자"></h1></div>
        <div class="admContainer">
            <div class="admForm">
                <h2><img src="<c:url value='/resources/img/adm_t1.png'/>" alt="LOGIN 로그인 정보를 입력하여 주십시오."></h2>
                <form id="frm" name="frm" action="" method="post">
                <fieldset>
                    <legend>경찰 관리자페이지 로그인</legend>                
                    <div class="logForm">
        ...
        <div class="admFooter"><img src="<c:url value='/resources/img/adm_footer.png'/>" alt="Copyright ⓒ 2015 WILLBES. All rights reserved."></div>
    </div>
</div>
</body>
</html>