...
<script type="text/javascript">
    ...
    <div class="firstheader">
        <h1><a href="<c:url value="/"/>"><img src="<c:url value="/resources/images/willbes_logo.png"/>" alt="경찰학원ㄴ" width="87" height="26" /></a></h1>
        <ul class="util">
        ...
        <c:if test="${not empty topMenuList}">
          <c:forEach items="${topMenuList}" var="list" varStatus="status">
            ...
            <%-- <li><a href="<c:url value="/main/left.do?MENU_ID=${list.MENU_ID}"/>"><c:out  value="${list.MENU_NM}"/></a> | </li> --%>
          </c:forEach>
           </c:if>
