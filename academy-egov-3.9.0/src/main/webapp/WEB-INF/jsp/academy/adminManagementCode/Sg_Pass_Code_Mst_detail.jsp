...
<input type="hidden" id="SYS_CD" name="SYS_CD"  value="<c:out value='${detail.SYS_CD}'/>">
<input type="hidden" id="CODE_VAL" name="CODE_VAL"  value="<c:out value='${detail.CODE_VAL}'/>">
<table class="table01" style="font-size: 9pt; min-width: 700px; width: 55%" >
	<tr>
		<th>공통코드</th>
		<td colspan=3 ><c:out value='${detail.SYS_CD}'/></td>
	</tr>
	<tr>
		<th>설정코드</th>
        <td colspan=3 ><c:out value='${detail.CODE_VAL}'/></td>
	</tr>       
	<tr>
		<th>순서</th>
		<td><input type="text" id="CODE_NO" name="CODE_NO" size="5"  value="<c:out value='${detail.CODE_NO}'/>"></td>
	</tr>
	<tr>
		<th>설정코드명</th>
		<td colspan=3 ><input type="text" id="CODE_NM" name="CODE_NM" size="60"  value="<c:out value='${detail.CODE_NM}'/>"></td>
	</tr>       
	<tr>
    	<th>상태</th>
        <td colspan=3 >
	...
	<tr>
		<th>코드설명</th>
		<td colspan=3 >
			<textarea rows="10" cols="70" id="CODE_INFO" name="CODE_INFO"><c:out value='${detail.CODE_INFO}'/></textarea>
