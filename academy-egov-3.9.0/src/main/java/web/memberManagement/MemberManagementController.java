...
public class MemberManagementController {
    ...
    public String memberInsert(ModelMap model, HttpServletRequest request) throws Exception {
        ...
        List<HashMap<String, String>> JOIN_CHANNELs = new ArrayList<HashMap<String, String>>();
        List<HashMap<String, String>> JOBs = new ArrayList<HashMap<String, String>>();
        List<HashMap<String, String>> EXAM_REQs = new ArrayList<HashMap<String, String>>();
        List<HashMap<String, String>> SBJ_REQs = new ArrayList<HashMap<String, String>>();
        List<HashMap<String, String>> S_CAT_CDs = new ArrayList<HashMap<String, String>>();
        List<HashMap<String, String>> AREAs = new ArrayList<HashMap<String, String>>();
        List<HashMap<String, String>> INFO_REQs = new ArrayList<HashMap<String, String>>();
        List<HashMap<String, String>> EVENT_REQs = new ArrayList<HashMap<String, String>>();
        Map<String, List<String>> searchList = new HashMap<String, List<String>>();
        ...
        List<HashMap<String, String>> ConfigCDs = cmmUseService.selectCmmCdMultiCondWthList(searchList);
        for(HashMap<String, String> map : ConfigCDs) {
            if("JOIN_CHANNEL".equals(map.get("SYS_CD").toString())) {
                JOIN_CHANNELs.add(map);
            } else if("JOB".equals(map.get("SYS_CD").toString())) {
                JOBs.add(map);
            } else if("EXAM_REQ".equals(map.get("SYS_CD").toString())) {
                EXAM_REQs.add(map);
            } else if("SBJ_REQ".equals(map.get("SYS_CD").toString())) {
                SBJ_REQs.add(map);
            } else if("S_CAT_CD".equals(map.get("SYS_CD").toString())) {
                S_CAT_CDs.add(map);
            } else if("AREA".equals(map.get("SYS_CD").toString())) {
                AREAs.add(map);
            } else if("INFO_REQ".equals(map.get("SYS_CD").toString())) {
                INFO_REQs.add(map);
            } else if("EVENT_REQ".equals(map.get("SYS_CD").toString())) {
                EVENT_REQs.add(map);
            }
        }
        model.addAttribute("JOIN_CHANNELs", JOIN_CHANNELs);
        model.addAttribute("JOBs", JOBs);
        model.addAttribute("EXAM_REQs", EXAM_REQs);
        model.addAttribute("SBJ_REQs", SBJ_REQs);
        model.addAttribute("S_CAT_CDs", S_CAT_CDs);
        model.addAttribute("AREAs", AREAs);
        model.addAttribute("INFO_REQs", INFO_REQs);
        model.addAttribute("EVENT_REQs", EVENT_REQs);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oldMemberDetail.do")
    public String oldMemberDetail(ModelMap model, HttpServletRequest request) throws Exception {
        HashMap<String, Object> params = new  HashMap<String, Object>();
        setParam(params, request, model);
        ...
        try {
            ...
            model.addAttribute("detail", memberManagementService.oldMemberDetail(params));

            model.addAttribute("params",params);
        }catch(Exception e){
            System.out.println("Member view error : " +e.toString());
        }
        return "/memberManagement/oldMemberDetail";
    }
