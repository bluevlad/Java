...
public class TeacherDAO extends EgovComAbstractDAO {
    ...
    public void teacherInfoInsert(Object obj){
        getSqlSession().insert("teacher.teacherInfoInsert", obj);
    }
    ...
    public void teacherInfoUpdate(Object obj){
        getSqlSession().update("teacher.teacherInfoUpdate", obj);
    }
