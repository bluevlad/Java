...
public class LectureController {
	...
	@RequestMapping(value="/listpop.pop")
	public String list_pop(ModelMap model, HttpServletRequest request) throws Exception {
		...
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/listpop";
	}
	@RequestMapping(value="/couponpop.pop")
	public String coupon_pop(ModelMap model, HttpServletRequest request) throws Exception {
...
//		model.addAttribute("pagingHtml", pagingHtml);
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/couponpop";
	}
	@RequestMapping(value="/mo_couponpop.pop")
	public String mu_coupon_pop(ModelMap model, HttpServletRequest request) throws Exception {
...
//		model.addAttribute("pagingHtml", pagingHtml);
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/mo_couponpop";
	}

	@RequestMapping(value="/Modify_Lecture_On_Off.do")
	@ResponseBody
	@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String Modify_Lecture_On_Off(ModelMap model, HttpServletRequest request) throws Exception {
	...
	public String bookList(ModelMap model, HttpServletRequest request) throws Exception {
		...
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/bookList_pop";
	}
	...
	public String save(ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<HashMap<String, String>> getBridgeLeccodeSeqList = lectureservice.getBridgeLeccodeSeq(params);			// 브릿지테이블 SEQ 구하기
		...
		List<HashMap<String, String>> getBridgeLeccodeList = lectureservice.getBridgeLeccode(params);					// 브릿지테이블 BRIDGE_LECCODE 구하기
		...
		return "redirect:/lecture/list.do?LEC_TYPE_CHOICE=" + params.get("LEC_TYPE_CHOICE");
	}
	@RequestMapping(value="/freesave.do")
	@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String freesave(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		Calendar cal = Calendar.getInstance( );
		String[] CATEGORY_CD_ARR = request.getParameterValues("CATEGORY_CD");
		...
		return "redirect:/lecture/freelist.do?LEC_TYPE_CHOICE=" + params.get("LEC_TYPE_CHOICE");
	}
	...
	public String freewrite(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		params.put("SEARCHGUBN", "T");
		List<HashMap<String, String>> kindlist = teacherservice.getKindList(params);
		...
		model.addAttribute("subjectteacherlist", subjectteacherlist);
		model.addAttribute("params", params);
		return "/lecture/lecture/freewrite";
	}
	...
	public String freelist(ModelMap model, HttpServletRequest request) throws Exception {
		...
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/freelist";
	}

	@RequestMapping(value="/freemodify.do")
	public String freemodify(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		...
		model.addAttribute("params", params);
		return "/lecture/lecture/freemodify";
	}
    ...
    public String listDelete(ModelMap model, HttpServletRequest request) throws Exception {
       ...
       return "forward:/lecture/freelist.do";
    }
	...
	@RequestMapping(value="/bookPopup.html")
	public String bookInfoPopup(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		model.addAttribute("params", params);
		...
		model.addAttribute("view", view);
		return "/lecture/lecture/commonBookPop";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/lecview.html")
	public String lecview(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);

		List<HashMap<String, String>> lecview = lectureservice.lectureView(params);
		
		model.addAttribute("lecview", lecview);
		return "/lecture/lecture/lecview";
	}
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String freeupdate(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		params.put("BRIDGE_LEC", CommonUtil.isNull(request.getParameter("BRIDGE_LEC"), ""));
		params.put("UPDATE_FLAG", CommonUtil.isNull(request.getParameter("UPDATE_FLAG"), ""));
...
//					        #{result, jdbcType=INTEGER, mode=OUT})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/freecopy.do")
	public String freeModify(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		...
		model.addAttribute("sdelyn", sdelyn);
		model.addAttribute("params", params);
		return "/lecture/lecture/freecopy";
	}
	...
	public String newCopyModify(ModelMap model, HttpServletRequest request) throws Exception {
		...
		model.addAttribute("sdelyn", sdelyn);
		model.addAttribute("params", params);
		return "/lecture/lecture/newCopy";
	}
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String copySave(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		Calendar cal = Calendar.getInstance( );
		String[] JU_RSC_ID_ARR = request.getParameterValues("JU_RSC_ID");
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String newCopySave(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		Calendar cal = Calendar.getInstance( );
		String[] CATEGORY_CD_ARR = request.getParameterValues("CATEGORY_CD");
	...
	public String seqList(ModelMap model, HttpServletRequest request) throws Exception {
		...
		params.put("SEARCHCODEISUSE", "Y");
		List<HashMap<String, String>> formlist = bookservice.getLearningFormList(params);
		List<HashMap<String, String>> list = lectureservice.lectureSeqList(params);

		model.addAttribute("kindlist", kindlist);
		model.addAttribute("formlist", formlist);
		model.addAttribute("list", list);
		model.addAttribute("params", params);
		return "/lecture/lecture/seqList";
	}
	...
	public String seqUpdate(ModelMap model, HttpServletRequest request) throws Exception {
		...
		if(SEQARR != null){
			for(int i=0; i<SEQARR.length; i++){
				...
				lectureservice.lectureSeqUpdate(params);
			}
		}
	...
	public String jongList(ModelMap model, HttpServletRequest request) throws Exception {
		...
		params.put("SEARCHCODEISUSE", "Y");
		List<HashMap<String, String>> formlist = bookservice.getLearningFormList(params);
		List<HashMap<String, String>> list = lectureservice.lectureJongList(params);
		int listCount = lectureservice.lectureJongListCount(params);
		String pagingHtml = new Paging(currentPage, listCount, pageRow).getPagingHtml().toString();
		...
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/jongList";
	}
	/**
	 * @Method Name : jongList
	 * @작성일 : 2013. 11.
	...
	public String YearList(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		/* 페이징 */
		int currentPage = Integer.parseInt(params.get("currentPage"));
		...
		params.put("SEARCHCODEISUSE", "Y");
		List<HashMap<String, String>> formlist = bookservice.getLearningFormList(params);
		List<HashMap<String, String>> list = lectureservice.lectureYearList(params);
		int listCount = lectureservice.lectureYearListCount(params);
		String pagingHtml = new Paging(currentPage, listCount, pageRow).getPagingHtml().toString();
		...
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/YearList";
	}
	...
	public String jongWrite(ModelMap model, HttpServletRequest request) throws Exception {
		...
		model.addAttribute("formlist", formlist);
		model.addAttribute("params", params);
		return "/lecture/lecture/jongWrite";
	}
	/**
	 * @Method Name : jongWrite
	 * @작성일 : 2013. 11.
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/yearWrite.do")
	public String yearwrite(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		params.put("SEARCHGUBN", "T");
		List<HashMap<String, String>> kindlist = teacherservice.getKindList(params);
		...
		model.addAttribute("formlist", formlist);
		model.addAttribute("params", params);
		return "/lecture/lecture/yearWrite";
	}
	...
	public String subjectList(ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<HashMap<String, String>> kindlist = teacherservice.getKindList(params);
		params.put("SEARCHCODEISUSE", "Y");
		String orgnLecTypeChoice = params.get("LEC_TYPE_CHOICE");
		//단과만 조회하므로 잠시 D로 바꾼다.
		params.put("LEC_TYPE_CHOICE", "D");
		List<HashMap<String, String>> formlist = bookservice.getLearningFormList(params);
		params.put("LEC_TYPE_CHOICE", orgnLecTypeChoice);
		List<HashMap<String, String>> list = lectureservice.lectureJongSubjectList(params);
		int listCount = lectureservice.lectureJongSubjectListCount(params);
		String pagingHtml = new Paging(currentPage, listCount, pageRow).getPagingHtml().toString();
		...
		model.addAttribute("params", params);
		model.addAttribute("totalPage", (int) Math.ceil((double) listCount / pageRow));
		return "/lecture/lecture/jongSubjectList_pop";
	}
    ...
    public String searchLectureList(ModelMap model, HttpServletRequest request) throws Exception {
        ...
        model.addAttribute("SEARCHSUBJECTs", teacherservice.getSubjectList(params)); //과목 목록
        model.addAttribute("SEARCHPRFIDs", teacherservice.teacherAllList(params)); //강사 목록
	...
	public String jongSave(ModelMap model, HttpServletRequest request, MultipartHttpServletRequest multipartRequest) throws Exception {
		...
		List<HashMap<String, String>> getJongLeccodeSeqList = lectureservice.getJongLeccodeSeq(params);			// JONG 브릿지 SEQ 구하기
			...
			for(int j=0; j<LEARNING_CD_ARR.length; j++){
				params.put("LEARNING_CD", LEARNING_CD_ARR[j]);
					...
					if("N".equals(params.get("LEC_TYPE_CHOICE"))){
						...
						lectureservice.lectureChoiceJongNoInsert(params);															// TB_CHOICE_JONG_NO (INSERT)
					}
		...
		return "redirect:/lecture/jongList.do?LEC_TYPE_CHOICE=" + params.get("LEC_TYPE_CHOICE");
	}
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String yearSave(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		Calendar cal = Calendar.getInstance( );
		String[] CATEGORY_CD_ARR = request.getParameterValues("CATEGORY_CD");
	...
	public String jongModify(ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<HashMap<String, String>> viewleccodelist = lectureservice.lectureViewLeccodeList(params);
		List<HashMap<String, String>> viewjonglist = lectureservice.lectureViewJongList(params);
		HashMap<String, String> vparams = new  HashMap<String, String>();
		String sdelyn = "Y";		// 관련글 삭제 가능여부
		String rdelyn = "Y";		// 현재 선택글 삭제가능여부
		...
		model.addAttribute("sdelyn", sdelyn);
		model.addAttribute("params", params);
		return "/lecture/lecture/jongModify";
	}
	/**
	 * @Method Name : jongModify
	 * @작성일 : 2013. 11.
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/yearModify.do")
	public String yearModify(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		...
		model.addAttribute("sdelyn", sdelyn);
		model.addAttribute("params", params);
		return "/lecture/lecture/yearModify";
	}
	...
	public String jongUpdate(ModelMap model, HttpServletRequest request, MultipartHttpServletRequest multipartRequest) throws Exception {
		...
		if("Y".equals(params.get("MUST_PRF_IMG_DEL")) || !"".equals(params.get("MUST_PRF_IMG")))
        	fileUtil.deleteFile(rootPath + params.get("MUST_PRF_IMG_DEL"));
		if("Y".equals(params.get("SEL_PRF_IMG_DEL")) || !"".equals(params.get("SEL_PRF_IMG")))
        	fileUtil.deleteFile(rootPath + params.get("SEL_PRF_IMG_DEL"));
		return "redirect:/lecture/jongList.do?LEC_TYPE_CHOICE=" + params.get("LEC_TYPE_CHOICE");
	}
	/**
	 * @Method Name : jongUpdate
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String yearUpdate(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		Calendar cal = Calendar.getInstance( );
		String[] MST_LECCODE_ARR = request.getParameterValues("MST_LECCODE");
		...
		if(MST_LECCODE_ARR != null){
			for(int k=0; k<MST_LECCODE_ARR.length; k++){
				...
				params.put("GUBUN","1");																					// 필수
				params.put("SORT", String.valueOf(k));
				if("N".equals(params.get("LEC_TYPE_CHOICE"))||"Y".equals(params.get("LEC_TYPE_CHOICE"))){
					params.put("SORT", MST_LECCODE_SORT[k]);
				}
				lectureservice.lectureLecJongInsert(params);															// TB_LEC_JONG (INSERT)
			}
		...
		return "redirect:/lecture/yearlist.do?LEC_TYPE_CHOICE=" + params.get("LEC_TYPE_CHOICE");
	}
	...
	public String jongDelete(ModelMap model, HttpServletRequest request) throws Exception {
		...
		lectureservice.lectureLecJongDelete(params);
		lectureservice.lectureChoiceJongNoDelete(params);
		return "forward:/lecture/jongList.do";
	}
	...
	public ExcelDownloadView excelDownload(ModelMap output, HttpServletRequest req) throws Exception {
		...
		//엑셀 리스트
		List<HashMap<String, String>> exe_list =lectureservice.lecturePayList(params);
		...
		for(HashMap<String, String> map : exe_list) {
			...
			excelName = "수강인원조회_온라인";
			
			newMap.put(i++, CommonUtil.isNull(map.get("USER_NM")));
			newMap.put(i++, CommonUtil.isNull(map.get("USERID")));
			newMap.put(i++, CommonUtil.isNull(map.get("SUBJECT_USER_NM")));
			newMap.put(i++, CommonUtil.isNull(map.get("SUBJECT_TITLE")));
			newMap.put(i++, CommonUtil.isNull(String.valueOf(map.get("ISCONFIRM")).substring(0, 10)));
	...
	public String jongPayList(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		List<HashMap<String, String>> list = lectureservice.lectureJongPayList(params);
		model.addAttribute("list", list);
		model.addAttribute("params", params);
		return "/lecture/lecture/payList_pop";
	}
	
	@RequestMapping(value="/FreePassPayList.pop")
	public String FreePassPayList(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		List<HashMap<String, String>> list = lectureservice.lectureFreePassPayList(params);
		model.addAttribute("list", list);
		model.addAttribute("params", params);
		return "/lecture/lecture/FreePasspayList_pop";
	}
	
	@RequestMapping(value="/FreePassDetailList.pop")
	public String FreePassDetailList(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		...
		List<HashMap<String, String>> viewleccodelist = lectureservice.YearIngList(params);
		List<HashMap<String, String>> list = lectureservice.MyYearIngList(params);
	...
	public String dataViewList(ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<HashMap<String, String>> memolist = lectureservice.lectureDataMemoViewList(params);
		List<HashMap<String, String>> list = lectureservice.lectureDataViewList(params);
		List<HashMap<String, String>> wmv = lectureservice.lectureWMV(params);
		List<HashMap<String, String>> down_count = lectureservice.lectureDown_Count(params);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/dataMovieViewList.pop")
	public String dataMovieViewList(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		List<HashMap<String, String>> memolist = lectureservice.lectureDataMemoViewList(params);
		List<HashMap<String, String>> list = lectureservice.lectureDataMovieList(params);
		List<HashMap<String, String>> view = lectureservice.lectureView(params);
		model.addAttribute("memolist", memolist);
		model.addAttribute("list", list);
		model.addAttribute("view", view);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/pmpDownloadView.pop3")
	public String pmpSampleDownloadView(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);

		params.put("MOVIE_NO", CommonUtil.isNull(request.getParameter("MOVIE_NO"),""));

		HashMap<String, String> detail  = lectureservice.lectureOnDetailS(params);	// 해당 선택형 종합반의 강의 정보를 조회한다.
		model.addAttribute("params", params);
		model.addAttribute("detail" , detail);
		return "/lecture/lecture/pmpPopupView";
	}
	/**
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/pmpDownloadLog.pop3")
	public void pmpDownloadLog(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);

		String userid = CommonUtil.isNull(request.getParameter("userid"),"");
		String cid = CommonUtil.isNull(request.getParameter("cid"),"");
		String downloginfo = CommonUtil.isNull(request.getParameter("downloginfo"),"");
		/*
			pmp다운로그를 남기위 함 시작
		*/
		String filename = "";
		...
		desc = contents_server+"  : "+ch+" : "+"/pmp/DownLog.asp : [CID = "+cid+"]";
		fileUtil.filemake(filename, desc, "pmpDownlog/");
		desc = contents_server+"  : "+ch+" : "+"/pmp/DownLog.asp : [추가정보 = "+downloginfo+"]";
		fileUtil.filemake(filename, desc, "pmpDownlog/");
		/* pmp다운로그를 남기위 함 종료 */
		/* DB에 저장하기 위함	시작 */
		params.put("USER_ID", userid);
		params.put("MOVIE_NO", cid);
		params.put("DOWNLOGINFO", downloginfo);
		lectureservice.insertPmpDownLog(params);
		/* DB에 저장하기 위함	종료 */
		model.addAttribute("params", params);

	    PrintWriter out = response.getWriter();
	    out.print("<res>0000</res>");
	}
	/**
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String dataMovieSave(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		int MOVIE_ORDER2 = Integer.parseInt(params.get("ADD_MOVIE_ORDER2"));
		for(int i=0; i<Integer.parseInt(params.get("ADD_LOW")); i++){
			params.put("ADD_MOVIE_ORDER2", String.valueOf(MOVIE_ORDER2));
			lectureservice.lectureMovieInsert(params);
			MOVIE_ORDER2 += 1;
		}
		model.addAttribute("params", params);
		return "/lecture/lecture/returnMsg";
	}
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String dataMovieAdd(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		HashMap<String, String> vparams = new  HashMap<String, String>();
		setParam(params, request, model);
		vparams.put("BRIDGE_LECCODE", params.get("BRIDGE_LECCODE"));
		// 동영상 정보 삭제
		String[] DEL_ARR = request.getParameterValues("DEL_ARR");
		if(DEL_ARR != null){
			for(int i=0; i<DEL_ARR.length; i++){
				String[] DEL_VAL_ARR = DEL_ARR[i].split(",");
				vparams.put("MOVIE_NO", DEL_VAL_ARR[0]);
				vparams.put("MOVIE_ORDER1", DEL_VAL_ARR[2]);
				vparams.put("MOVIE_ORDER2", DEL_VAL_ARR[3]);
				lectureservice.lectureMovieDelete(vparams);
			}
		}
		// 메모 정보 삭제
		String[] DELMEMO_ARR = request.getParameterValues("DELMEMO_ARR");
		if(DELMEMO_ARR != null){
			for(int i=0; i<DELMEMO_ARR.length; i++){
				String[] DELMEMO_ARR_SPLIT = DELMEMO_ARR[i].toString().split(",");
				vparams.put("POSITION", DELMEMO_ARR_SPLIT[0]);
				vparams.put("MOVIE_ORDER1", DELMEMO_ARR_SPLIT[1]);
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String dataMovieUpdate(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		HashMap<String, String> vparams = new  HashMap<String, String>();
		setParam(params, request, model);

		String[] MOVIE_NO = request.getParameterValues("MOVIE_NO");
		String[] MOVIE_ORDER1 = request.getParameterValues("MOVIE_ORDER1");
		String[] MOVIE_ORDER2 = request.getParameterValues("MOVIE_ORDER2");
		String[] MOVIE_ORDERS1 = request.getParameterValues("MOVIE_ORDERS1");
		String[] MOVIE_ORDERS2 = request.getParameterValues("MOVIE_ORDERS2");
		String[] MOVIE_NAME = request.getParameterValues("MOVIE_NAME");
		String[] MOVIE_DESC = request.getParameterValues("MOVIE_DESC");
		String[] MOVIE_URL = request.getParameterValues("MOVIE_URL");
		String[] WIDE_URL = request.getParameterValues("WIDE_URL");
		String[] MOVIE_FILENAME1 = request.getParameterValues("MOVIE_FILENAME1");
		String[] MP4_URL = request.getParameterValues("MP4_URL");
		String[] MOVIE_FILENAME2 = request.getParameterValues("MOVIE_FILENAME2");
		String[] MOVIE_FILENAME3 = request.getParameterValues("MOVIE_FILENAME3");
		String[] MOVIE_FILENAME4 = request.getParameterValues("MOVIE_FILENAME4");
		String[] PMP_URL = request.getParameterValues("PMP_URL");
		String[] PMP_FILENAME = request.getParameterValues("PMP_FILENAME");
		String[] MOVIE_TIME = request.getParameterValues("MOVIE_TIME");
		String[] MOVIE_FREE_FLAG = request.getParameter("MOVIE_FREE_FLAG").toString().split(",");
		String[] STOP = request.getParameter("STOP").toString().split(",");
		String[] MOVIE_DATA_FILE_YN = request.getParameter("MOVIE_DATA_FILE_YN").toString().split(",");
		String[] MOVIE_DATA_FILENAME = request.getParameterValues("MOVIE_DATA_FILENAME");

		if(MOVIE_NO != null){
			for(int i=0; i<MOVIE_NO.length; i++){
				vparams.put("MOVIE_NO", MOVIE_NO[i]);
				vparams.put("MOVIE_ORDER1", MOVIE_ORDER1[i]);
				vparams.put("MOVIE_ORDER2", MOVIE_ORDER2[i]);
				vparams.put("MOVIE_NAME", MOVIE_NAME[i]);
				vparams.put("MOVIE_DESC", MOVIE_DESC[i]);
				vparams.put("MOVIE_URL", MOVIE_URL[i]);
				vparams.put("WIDE_URL", WIDE_URL[i]);
				vparams.put("MOVIE_FILENAME1", MOVIE_FILENAME1[i]);
				vparams.put("MOVIE_FILENAME4", MOVIE_FILENAME4[i]);
				if(!MOVIE_FILENAME1[i].equals("")){
					vparams.put("MOVIE_FILENAME1_FLAG", MOVIE_FILENAME1[i].substring( MOVIE_FILENAME1[i].length()-3, MOVIE_FILENAME1[i].length()));
				}
				if(!MOVIE_FILENAME4[i].equals("")){
					vparams.put("MOVIE_FILENAME4_FLAG", MOVIE_FILENAME4[i].substring( MOVIE_FILENAME4[i].length()-3, MOVIE_FILENAME4[i].length()));
				}

				if(!MOVIE_FILENAME4[i].equals("") && MOVIE_FILENAME2[i].equals("")){
					vparams.put("MOVIE_FILENAME2", MOVIE_FILENAME4[i].substring(0, MOVIE_FILENAME4[i].length()-6)+"_3.mp4"); // 저화질 _3
				}else{
					vparams.put("MOVIE_FILENAME2", MOVIE_FILENAME2[i]); // 저화질 _3
				}
				
				if(!MOVIE_FILENAME4[i].equals("") && MOVIE_FILENAME3[i].equals("")){
					vparams.put("MOVIE_FILENAME3", MOVIE_FILENAME4[i].substring(0, MOVIE_FILENAME4[i].length()-6)+"_2.mp4"); // 고화질 _2		
				}else{
					vparams.put("MOVIE_FILENAME3", MOVIE_FILENAME3[i]); // 고화질 _2
				}
				vparams.put("MP4_URL", MP4_URL[i]);
				vparams.put("PMP_URL", PMP_URL[i]);
				vparams.put("PMP_FILENAME", PMP_FILENAME[i]);
				vparams.put("MOVIE_TIME", MOVIE_TIME[i]);
				vparams.put("MOVIE_DATA_FILENAME", MOVIE_DATA_FILENAME[i]);
				vparams.put("MOVIE_FREE_FLAG", MOVIE_FREE_FLAG[i]);
				vparams.put("STOP", STOP[i]);
				vparams.put("MOVIE_DATA_FILE_YN", MOVIE_DATA_FILE_YN[i]);
		...
		String[] MST_TEXT = request.getParameterValues("MST_TEXT");
		String MOV_ING = request.getParameter("MOV_ING");
		if(MST_TEXT != null){
			for(int i=0; i<MST_TEXT.length; i++){
				vparams.put("POSITION", POSITION[i]);
				vparams.put("MOVIE_ORDERS1", MOVIE_ORDERS1[i]);
				vparams.put("MOVIE_ORDERS2", MOVIE_ORDERS2[i]);
				vparams.put("MST_TEXT", MST_TEXT[i]);
				lectureservice.lectureMovieMemoUpdate(vparams);
			}
		}
		if(MOV_ING != null){
			vparams.put("MOV_ING", MOV_ING);
			lectureservice.lecMovUpdate(vparams);
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/dataMovieFile.pop")
	public String dataMovieFile(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		params.put("LOWNUM", request.getParameter("LOWNUM"));
		params.put("BLECCODE", request.getParameter("BLECCODE"));
		model.addAttribute("params", params);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/dataMovieFileSave.pop")
	public String dataMovieFileSave(ModelMap model, HttpServletRequest request, MultipartHttpServletRequest multipartRequest) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);

		MultipartFile ATTACH_FILE = multipartRequest.getFile("ATTACH_FILE");
		String bridgePath = CommonUtil.isNull(request.getParameter("BLECCODE"), "");

		Calendar cal = Calendar.getInstance( );
		String rootPath = fsResource.getPath();
		//String subPath = "lecture_upload/" + cal.get(Calendar.YEAR) + "/" ;
		String subPath = "lecture_upload/" + bridgePath + "/" ;

		if(ATTACH_FILE != null && ATTACH_FILE.isEmpty() == false) {
			HashMap<String, Object> fileMap1 = fileUtil.uploadFileForRealName(ATTACH_FILE, rootPath, subPath);
			params.put("ATTACH_FILE", fileMap1.get("fileFullPath").toString());
		}

		params.put("LOWNUM", request.getParameter("LOWNUM"));
		params.put("RETURNDATA", "Y");
		model.addAttribute("params", params);
		return "/lecture/lecture/dataMovieFile";
	}
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String dataMovieFileDelete(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		lectureservice.lectureMovieFileDelete(params);
		String rootPath = fsResource.getPath();
		fileUtil.deleteFile(rootPath + CommonUtil.isNull(params.get("FILE_DEL_NAME"), ""));
		model.addAttribute("params", params);
		return "/lecture/lecture/returnMsg";
	}
	...
	//@Transactional(readOnly=false,rollbackFor=Exception.class)
	public String dataMovieMemoSave(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		lectureservice.lectureMovieMemoInsert(params);
		model.addAttribute("params", params);
		return "/lecture/lecture/returnMsg";
	}
	...
	public void setParam(HashMap<String, String> params, HttpServletRequest request, ModelMap model) throws Exception {
		...
		params.put("S_LEC_BAESU", CommonUtil.isNull(request.getParameter("S_LEC_BAESU"), ""));
		params.put("DownType", CommonUtil.isNull(request.getParameter("DownType"), "X"));
		...
		params.put("ORG_LECCODE", CommonUtil.isNull(request.getParameter("ORG_LECCODE"), ""));
		...
		params.put("SEARCHGIFT", CommonUtil.isNull(request.getParameter("SEARCHGIFT"), ""));
		params.put("GIFT_SEARCHTYPE", CommonUtil.isNull(request.getParameter("GIFT_SEARCHTYPE"), ""));
		params.put("SEARCHGIFTTEXT", CommonUtil.isNull(request.getParameter("SEARCHGIFTTEXT"), ""));
		params.put("GIFT_FLAG", CommonUtil.isNull(request.getParameter("GIFT_FLAG"), ""));
		params.put("GIFT_LECCODE", CommonUtil.isNull(request.getParameter("GIFT_LECCODE"), ""));
		params.put("MO_COUPON_CCODE", CommonUtil.isNull(request.getParameter("MO_COUPON_CCODE"), ""));
		params.put("MO_COUPON_NAME", CommonUtil.isNull(request.getParameter("MO_COUPON_NAME"), ""));
		params.put("GIFT_LECCODE", CommonUtil.isNull(request.getParameter("GIFT_LECCODE"), ""));
		params.put("GIFT_COUPON_CCODE", CommonUtil.isNull(request.getParameter("GIFT_COUPON_CCODE"), ""));
		params.put("COUPON_NAME", CommonUtil.isNull(request.getParameter("COUPON_NAME"), ""));
		params.put("GIFT_NAME", CommonUtil.isNull(request.getParameter("GIFT_NAME"), ""));
		params.put("TEACHERNO", CommonUtil.isNull(request.getParameter("TEACHERNO"), ""));
		params.put("MO_SEARCHTYPE", CommonUtil.isNull(request.getParameter("MO_SEARCHTYPE"), ""));
		params.put("SEARCHMOTEXT", CommonUtil.isNull(request.getParameter("SEARCHMOTEXT"), ""));
        ...
        params.put("ICON_GUBUN", CommonUtil.isNull(request.getParameter("ICON_GUBUN"), ""));
        params.put("FREE_TAB", CommonUtil.isNull(request.getParameter("FREE_TAB"), ""));
        params.put("SUBJECT_MONITORMODE", CommonUtil.isNull(request.getParameter("SUBJECT_MONITORMODE"), ""));
        params.put("LEC_BAESU", CommonUtil.isNull(request.getParameter("LEC_BAESU"), "00"));
        
        params.put("MUST_PRF_IMG_DEL", CommonUtil.isNull(request.getParameter("MUST_PRF_IMG_DEL"), ""));
        params.put("SEL_PRF_IMG_DEL", CommonUtil.isNull(request.getParameter("SEL_PRF_IMG_DEL"), ""));
        params.put("MUST_PRF_IMG_DELNM", CommonUtil.isNull(request.getParameter("MUST_PRF_IMG_DELNM"), ""));
        params.put("SEL_PRF_IMG_DELNM", CommonUtil.isNull(request.getParameter("SEL_PRF_IMG_DELNM"), ""));
        
        
        params.put("MUST_PRF_IMG", "");
		params.put("SEL_PRF_IMG", "");
    ...
    public HashMap<String, String> lecFileProcess(HashMap params, MultipartHttpServletRequest multipartRequest) throws Exception {
		...
		if(MUST_PRF_IMG != null && MUST_PRF_IMG.isEmpty() == false) {
			HashMap<String, Object> fileMap1 = fileUtil.uploadFile(MUST_PRF_IMG, rootPath, subPath);
			params.put("MUST_PRF_IMG", fileMap1.get("fileFullPath").toString());
			Thread.sleep(100);
		}
		if(SEL_PRF_IMG != null && SEL_PRF_IMG.isEmpty() == false) {
			HashMap<String, Object> fileMap2 = fileUtil.uploadFile(SEL_PRF_IMG, rootPath, subPath);
			params.put("SEL_PRF_IMG", fileMap2.get("fileFullPath").toString());
			Thread.sleep(100);
		}
	...
	@ResponseBody 
	public HashMap<String, String> oldFreeToNewFree(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
	...
	@ResponseBody 
	public HashMap<String, String> oldBogangFreeToNewBogangFree(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
