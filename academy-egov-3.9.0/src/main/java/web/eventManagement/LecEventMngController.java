...
public class LecEventMngController {
	...
	public String eventInsertProcess(ModelMap model, HttpServletRequest request, MultipartHttpServletRequest multipartRequest) throws Exception {
		...
		model.addAttribute("params",params);
 		return "redirect:/LecEventMng/eventMgtList.do";
	}
	...
	public String eventUpdateProcess(ModelMap model, HttpServletRequest request, MultipartHttpServletRequest multipartRequest) throws Exception {
		...
		model.addAttribute("params",params);
 		return "forward:/LecEventMng/eventDetail.do";
	}
	...
	*/
    ...
    public String setReboundChk(ModelMap model, HttpServletRequest request) throws Exception {
        ...
        params.put("EVENT_NO", CommonUtil.isNull(request.getParameter("EVENT_NO"), ""));
        params.put("message", CommonUtil.isNull(request.getParameter("MESSAGE"), ""));
        params.put("is_mms", CommonUtil.isNull(request.getParameter("is_mms"), "N"));
        ...
        if(!"".equals(params.get("EVENT_USER_ID"))
        	...
        	if(!"Y".equals(params.get("ARM_EVENT"))){
	    		...
	    		//환승이벤트 시 자동 쿠폰 지급(승인:유무 체크 추가, 취소:유무체크 삭제)
	    		LecEventMngService.insertDelEventCoupon(params);
        	}
	 ...
	 * @throws UnsupportedEncodingException
	*/
	@RequestMapping(value="/supportEventList.do")
	public String supportEventList(ModelMap model, HttpServletRequest request) throws Exception {
		HashMap<String, String> params = new  HashMap<String, String>();
		setParam(params, request, model);
		...
		HashMap<String, Object> oparam = new  HashMap<String, Object>();
		oparam.put("SYS_CD", "SUPPORT_EVENT");
		List<HashMap<String, Object>> eventList = codeService.getBaConfigCodeList(oparam);
        ...
        List<HashMap<String, String>> list = LecEventMngService.getSupportEventList(params);
        int listCount = LecEventMngService.getSupportEventListCount(params);
		...
		return "/eventManagement/supportEvent";
	}
	
	/**
     * @Method Name : supportExcelDownload
     * @작성일 : 2017. 12.
     * @Method 설명 : 서포터즈 이벤트 엑셀 다운로드
     * @param model
     * @param request
     * @return String
     * @throws Exception
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/supportExcel.do")
    public View supportExcelDownload(ModelMap model, HttpServletRequest request) throws Exception {
        HashMap<String, String> params = new HashMap<String, String>();
        setParam(params, request, model);
        ...
        for(HashMap<String, String> map : list) {
        	...
        	if(null != map.get("TXT") && !"".equals(map.get("TXT"))) {
