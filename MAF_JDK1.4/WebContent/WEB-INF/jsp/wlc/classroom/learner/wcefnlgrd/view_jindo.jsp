      ...
      <c:choose>
        ...
        <tr >
           ...
           <td align="left"><mh:out value="${sitem.itm_title}" td="true" /></td>
            ...
            <td align=left>
                <img src="<mh:out value="${CPATH}"/>/maf_images/graph/graph10.gif" width="100" height="12"/>100.0% (<mh:out value="${sitem.t_page}" td="true" />P/<mh:out value="${sitem.t_page}" td="true" />P)</td>
            </td>
              </c:when>
              <c:otherwise>
            <td align=left>
              <c:if test="${avg_page > 0.0}">
                <img src="<mh:out value="${CPATH}"/>/maf_images/graph/graph10.gif" width="100" height="12"/>
