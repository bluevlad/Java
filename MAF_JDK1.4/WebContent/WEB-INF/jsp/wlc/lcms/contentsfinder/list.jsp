...
<tr>
	<td valign=top><div id="oList" style="overflow: scroll; width: 550px; height: 470px;"">
	<table border="0" width="100%" cellspacing="1" cellpadding="0">
        <thead style="background :url(/hkmca/maf_images/thead/bg_01.gif) repeat-x bottom;">
		<tr>
			<th class="tth"  >file name</th>
			<th class="tth" align="center" >size</th>
			<th class="tth"  align="center" nowrap>modified date</th>
		</tr>
        </thead>
        <tbody>
		...
		<tr>
			<td  class="list_td" >
				...
				</c:url>'><img src='<c:url value="/js/dtree/img/up.gif"/>' alt="Up" border="0" align="absmiddle">[<c:out value="${upPath}"/>]</a>
			</td>
		</tr>
		</c:if>
		<c:forEach var="list" items="${lists}">
		<tr onmouseover="this.style.backgroundColor='#b6b6b6'" onmouseout="this.style.backgroundColor='#FFFFFF'">
			<td class="list_td" nowrap width="190"><table border="0" cellspacing="0" cellpadding="0">
				<tr>
...
<tr><td height=1 bgcolor="#D6D3CE"></td></tr>
</table>