...
<!--
	...
	function popUser(leccode){
	    var frm = getObject("myform");
        window.open("<%=request.getContextPath()%>/hkmca.report/LecYearOn.do?cmd=pop&leccode="+leccode, "pop", "width=10, height=10, status=yes, toolbar=no, scrollbars=yes");
	}
//-->
</SCRIPT>
        ...
        <td><div class="searchContainer">
	        ...
	        <table width="100%" border="0" cellspacing="0" cellpadding="2" class="search">
				...
				<tr>
					...
					<td colspan="3"><mf:input type="text" size="50" name="s_lecname" value="${LISTOP.ht.s_lecname}"/></td>					
				</tr>
	        </table>
	    ...
	    <td><div class="listContainer">
			...
			<thead>
			    <tr>
		            ...
		            <th><mf:header name="lecture.complete" sort="true"/></th>
			    </tr>
		    </thead>
		    <tbody>
				...
				<tr>
					...
					<td class="center"><a href="javascript:popUser('<mh:out value="${item.leccode}"/>');"><mh:out value="${item.cnt_le}" td="true"/></a></td>
				</tr>
			    </c:forEach>
		    </tbody>
		    </table>
