...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
    <tr>
        ...
        <mf:form action="${control_action}" method="post" name="myform" id="myform"
            ...
            <mf:input type='hidden' name='s_cat_id' value='${LISTOP.ht.s_cat_id}'/>
            <table width="100%" border="0" cellspacing="0" cellpadding="2" class="search">
                <tr>
                    ...
                    <td><mf:input type="text" name="s_cat_name" value="${LISTOP.ht.s_cat_name}" onclick="CategorySelector.showList('s_cat_name')" cssClass="dropdown"/>
                    <div id="catTreeDiv" ></div></td>
                </tr>
                <tr>
                    <th><mf:label name="active_yn" for="s_active_yn" /></th>
                    <td><mf:select name="s_active_yn" curValue="${LISTOP.ht.s_active_yn}" codeGroup="ACTIVE_YN">
                        <option value="">-</option>
                    </mf:select></td>
                </tr>
            </table>
            ...
            <tbody>
                <c:forEach var="item" items="${navigator.list}" varStatus="status">
                    <tr>
                        ...
                        <td align="center"><mh:out value="${item.update_usn}" td="true" />,<mh:out value="${item.update_dt}" format="fulldate" td="true" /></td>
