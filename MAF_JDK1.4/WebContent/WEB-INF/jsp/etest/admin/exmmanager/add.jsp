...
<mf:form action="${control_action}" method="post" name="myform" id="myform" onSubmit=" frmSubmit('myform');return false;">
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">
        ...
        <tr>
            ...
            <td colspan="3"><mf:input type="text" name="exmdesc" size="100" maxlength="50" value="" /></td>
        </tr>
        <tr>
            <th nowrap>Set</th>
        ...
        <tr>
            ...
            <td><mf:input type="date" name="exm_sdat_t1" size="10" value="" readonly="true" 
                onclick="popUpCalendar(this, this, 'yyyy-mm-dd');" cssClass="dropdown"/></td>
            <th nowrap><mf:label name="exm_edat_t1" /></th>
            <td><mf:input type="date" name="exm_edat_t1" size="10" value="" readonly="true" 
                onclick="popUpCalendar(this, this, 'yyyy-mm-dd');" cssClass="dropdown"/></td>
        </tr>
        <tr>
