...
<form action="${control_action}" method="post" name="myform" id="myform" onSubmit="return frmSubmit(this)">
	...
	<tr>
	    ...
	    <td class="view">${mhtml:null2nbsp(item.msgid)}</td>
 	</tr>
	
	<tr>
	    <th class="view" nowrap><mform:label name="usn_snd"/></th> 
	    <td class="view">${mhtml:null2nbsp(item.usn_snd)}</td>
 	</tr>
	
	<tr>
	    <th class="view" nowrap><mform:label name="usn_rcv"/></th> 
	    <td class="view">${mhtml:null2nbsp(item.usn_rcv)}</td>
 	</tr>
	
	<tr>
	    <th class="view" nowrap><mform:label name="nm_snd"/></th> 
	    <td class="view">${mhtml:null2nbsp(item.nm_snd)}</td>
 	</tr>
	
	<tr>
	    <th class="view" nowrap><mform:label name="nm_rcv"/></th> 
	    <td class="view">${mhtml:null2nbsp(item.nm_rcv)}</td>
 	</tr>
	...
	<tr>
	    ...
	    <td class="view">${mhtml:null2nbsp(item.contents)}</td>
 	</tr>
	
	<tr>
	    <th class="view" nowrap><mform:label name="reg_dt"/></th> 
	    <td class="view">${mfmt:shortDate(item.reg_dt)}</td>
 	</tr>
	
	<tr>
	    <th class="view" nowrap><mform:label name="rcv_dt"/></th> 
	    <td class="view">${mfmt:shortDate(item.rcv_dt)}</td>
 	</tr>
	
	<tr>
	    <th class="view" nowrap><mform:label name="deleted"/></th> 
	    <td class="view">${mhtml:null2nbsp(item.deleted)}</td>
 	</tr>
