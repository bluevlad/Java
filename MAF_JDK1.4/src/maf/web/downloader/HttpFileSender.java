...
public class HttpFileSender {
	...
	private boolean process(File file, String newFileName, boolean dnyn, boolean cacheyn,
	        String encording) {
		boolean chk = false;
		try {
	...
	private boolean _process(File file, String newFileName, boolean dnyn,
	        boolean cacheyn, String encording) throws IOException {
		long seek_start = 0L;
		byte abyte0[] = null;
		if (encording == null) {
			encording = "";
