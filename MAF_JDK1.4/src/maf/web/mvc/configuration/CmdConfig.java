...
public class CmdConfig extends BaseObject{
	public static final String CMD_TYPE_JSP = "JSP";
	public static final String CMD_TYPE_JAVA = "JAVA";
	/**
	 * 
	 */
	...
	private String cmdtype = CmdConfig.CMD_TYPE_JAVA;
	/**
	...
	public void setCmdtype(String type) {
		if("jsp".equalsIgnoreCase(type)) {
			this.cmdtype = CmdConfig.CMD_TYPE_JSP;
		}
    }
