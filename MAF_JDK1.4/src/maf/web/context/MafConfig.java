...
//		context_path = _instance.servletContext.getInitParameter("CONTEXT_PATH");
//		context_image_path = _instance.servletContext.getInitParameter("CONTEXT_IMAGE_PATH");
...
//			this.localeResolver = MafProperties.MAF_LOCALE_RESOLVER;
			try {
