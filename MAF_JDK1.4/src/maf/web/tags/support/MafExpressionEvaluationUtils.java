 ...
 */
public abstract class MafExpressionEvaluationUtils {
	...
	private static final String EXPRESSION_CACHE_FLAG_CONTEXT_ATTR =
			MafExpressionEvaluationUtils.class.getName() + ".CACHE_JSP_EXPRESSIONS";

	private static final String EXPRESSION_CACHE_MAP_CONTEXT_ATTR =
			MafExpressionEvaluationUtils.class.getName() + ".JSP_EXPRESSION_CACHE";
	...
	private static final Log logger = LogFactory.getLog(MafExpressionEvaluationUtils.class);
