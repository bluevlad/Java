 ...
 */
package maf.web.tags.fmt.support;

import javax.servlet.jsp.JspException;
import javax.servlet.jsp.JspTagException;
import javax.servlet.jsp.tagext.BodyTagSupport;
import javax.servlet.jsp.tagext.Tag;
import maf.web.tags.fmt.MafMessageTag;
...
public class MafParamSupport extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
		Tag t = findAncestorWithClass(this, MafMessageTag.class);
		if (t == null) {
			throw new JspTagException(Resources.getMessage("PARAM_OUTSIDE_MESSAGE"));
		}
		MafMessageTag parent = (MafMessageTag) t;
