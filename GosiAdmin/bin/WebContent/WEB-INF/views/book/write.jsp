   	...
   	<table class="table01">
		...
		<tr>
   		...
   		<tr>
   			<th>목차</th>
  			<td>
	   			<textarea id="BOOK_CONTENTS" name="BOOK_CONTENTS" ROWS="7" onkeyup="fn_GetLen(1);" style="width:68%;"></textarea>
  			</td>
  		</tr>  		
   		<tr>
   			<th>메모(목차2)</th>
  			<td>
	   			<textarea id="BOOK_MEMO" name="BOOK_MEMO" ROWS="7" onkeyup="fn_GetLen(2);" style="width:68%;"></textarea>
  			</td>
  		</tr>		
		<tr>
   			<th>도서가격</th>
