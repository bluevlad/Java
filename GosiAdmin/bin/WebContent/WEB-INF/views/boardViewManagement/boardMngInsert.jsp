	...
	<h2>● 게시판 관리 > <strong>게시판 관리</strong></h2>
    	...
    	<tr>
    		<th >게시판명</th>
   			<td>
   				<div class="item" >
	   				<input type="text" id="BOARD_NAME" name="BOARD_NAME"  title="레이블 텍스트" value="" size="20"  maxlength="20" style="width:28% ; background:#FFECEC;" />
				</div>
   			</td>
   		</tr>
   		<tr>
   			<th>게시판 타입</th>
  			<td>
				<select  id="BOARD_TYPE" name="BOARD_TYPE" onchange="fn_change(this)"> &nbsp;
