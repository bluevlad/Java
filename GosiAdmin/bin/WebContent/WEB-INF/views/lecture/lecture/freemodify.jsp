...
<c:if test="${!empty view[0].SUBJECT_OPTION}">
    ...
    <table class="table01">
        ...
        <tr>
            ...
            <td>
                <ul class="lecSerial">
                <li>입문특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_001" <c:if test="${view[0].FREE_TAB eq 'TAB_001' }">checked="checked"</c:if>/></span></li>
	            <li>테마별특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_002"  <c:if test="${view[0].FREE_TAB eq 'TAB_002' }">checked="checked"</c:if>/></span></li>
	           	<li>마무리특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_003"  <c:if test="${view[0].FREE_TAB eq 'TAB_003' }">checked="checked"</c:if>/></span></li>
	            <li>모의고사해설<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_004"  <c:if test="${view[0].FREE_TAB eq 'TAB_004' }">checked="checked"</c:if>/></span></li>
	            <li>기출해설특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_005"  <c:if test="${view[0].FREE_TAB eq 'TAB_005' }">checked="checked"</c:if>/></span></li>
	            <li>합격설명회<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_006"  <c:if test="${view[0].FREE_TAB eq 'TAB_006' }">checked="checked"</c:if>/></span></li>
	            <li>보강동영상<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_007" <c:if test="${view[0].FREE_TAB eq 'TAB_007' }">checked="checked"</c:if> /></span></li>
                </ul>
            </td>
            <td>
                <ul class="lecSerial">
  ...
  <%--<tr>
      ...
      <%-- <tr>
          <th><span class="txt03">무료강좌종류</span></th>
          <td>
            <input type="radio" name="FREE_TAB" value="TAB_001" <c:if test="${view[0].FREE_TAB eq 'TAB_001' }">checked="checked"</c:if>/><span class="txt03">입문특강</span>
            <input type="radio" name="FREE_TAB" value="TAB_002" <c:if test="${view[0].FREE_TAB eq 'TAB_002' }">checked="checked"</c:if>/><span class="txt03">테마별특강</span>
            <input type="radio" name="FREE_TAB" value="TAB_003" <c:if test="${view[0].FREE_TAB eq 'TAB_003' }">checked="checked"</c:if>/><span class="txt03">마무리특강</span>
            <input type="radio" name="FREE_TAB" value="TAB_004" <c:if test="${view[0].FREE_TAB eq 'TAB_004' }">checked="checked"</c:if>/><span class="txt03">모의고사해설</span>
            <input type="radio" name="FREE_TAB" value="TAB_005" <c:if test="${view[0].FREE_TAB eq 'TAB_005' }">checked="checked"</c:if>/><span class="txt03">기출해설특강</span>
            <input type="radio" name="FREE_TAB" value="TAB_006" <c:if test="${view[0].FREE_TAB eq 'TAB_006' }">checked="checked"</c:if>/><span class="txt03">합격설명회</span>
            <input type="radio" name="FREE_TAB" value="TAB_007" <c:if test="${view[0].FREE_TAB eq 'TAB_007' }">checked="checked"</c:if>/><span class="txt03">보강동영상</span>
            </td>
      </tr> --%>
<%--       <tr>
    ...
    <%--   <tr>
            ...
            <td>
                <table class="table01">
                    <tr>
                        <th width="25%">
                        단과명 : <input type="text" name="GIFT_NAME" id="GIFT_NAME" value="${view[0].GIFT_NAME}" size="150" readonly="readonly"> <input type="hidden" name="GIFT_LECCODE" id="GIFT_LECCODE" value="">
                        ...
                        <label for="SEARCHKIND"></label>
                            ...
                            <input type="text" id="SEARCHGIFT" name="SEARCHGIFT" value="" size="40" title="검색어" onkeypress="fn_Enter()">
      ...
      <tr>
            ...
            <td>
                <table class="table01">
                    <tr>
                        <th width="25%">
                        쿠폰명 : <input type="text" name="COUPON_NAME" id="COUPON_NAME" value="${view[0].COUPON_NAME}" size="150" readonly="readonly"> <input type="hidden" name="GIFT_COUPON_CCODE" id="GIFT_COUPON_CCODE" value="">
      ...
      <tr>
          ...
          <tr>
                <th width="25%">
                쿠폰명 : <input type="text" name="MO_COUPON_NAME" id="MO_COUPON_NAME" value="${view[0].MO_COUPON_NAME}" size="150" readonly="readonly"> <input type="hidden" name="MO_COUPON_CCODE" id="MO_COUPON_CCODE" value="">
              ...
              <input type="text" id="SEARCHMOTEXT" name="SEARCHMOTEXT" value="" size="40" title="검색어" onkeypress="fn_Enter3()">
...
function fn_Modify(val1, val2){
    ...
    $("#LECCODE").val(val2);
    $("#frm").attr("action", "<c:url value='/lecture/freemodify.do' />");
    $("#frm").submit();
}
...
/*     if(1 > $("input[name='LEARNING_CD']:checked").size()){
    ...
    if(FLAG == 'All'){
        ...
        $("#frm").attr("action","<c:url value='/lecture/freeupdate.do' />");
        $("#frm").submit();
    }
}
...
function div_mo_search(){
  ...
  var param =  "&MO_SEARCHTYPE=" + $('#MO_SEARCHTYPE').val()+"&SEARCHMOTEXT=" + $('#SEARCHMOTEXT').val();
  $.ajax({
        type : "POST"
