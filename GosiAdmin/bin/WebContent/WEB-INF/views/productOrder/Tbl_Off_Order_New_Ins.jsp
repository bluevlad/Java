...
function checkParam() {
	...
	$('#searchFrm').attr('action','<c:url value="/productOrder/registrationRefundNewInsert.do"/>').submit();
}
	...
	<h2>● 수강신청관리 > <strong>수강신청</strong></h2>	
    	...
    	<tr>
			           ...
			           <table class="tbl_type" style="margin-top:10px; float:left; width:95%;" border="1">
			             ...
			             <tr style="background-color:${colors}">
							...
							<td>
								...
								<input type="text" id="REALPRICE_${list.NUM}" name="REALPRICE_${list.NUM}"  onBlur="self_dis2()" style="width:80px; background:#FFECEC;" value="${list.REALPRICE}"/>
   		...
   		<tr>
    		<th >관리자 추가할인</th>
   			<td >
				<input name="PRICE_DISCOUNT_TYPE" id="PRICE_DISCOUNT_TYPE1" value="R" type="radio" checked="checked"/>비율(%)
				&nbsp;
   				<input type="text" id="PRICE_DISCOUNT" name="PRICE_DISCOUNT"  title="레이블 텍스트" value="0" style="width:10%; background:#FFECEC;"/>
