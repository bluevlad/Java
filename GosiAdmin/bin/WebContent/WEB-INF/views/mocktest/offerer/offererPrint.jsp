...
<!--
    function fn_barProc() 
    {
        ...
        */
        ...
        ctkprint_bar.prt_text_L2 = "                     성명 : ${view[0].USRNM};굴림;10;true;left";
        ctkprint_bar.prt_text_L6 = "                                      응시번호 : ${fn:substring(view[0].IDENTYID, 4, 12)};굴림;8;false;left";
        ctkprint_bar.prt_text_L10 = "        ${view[0].MOCKNAME};굴림;8;false;left";
        ctkprint_bar.prt_text_L14 = "                          [ ${view[0].CLASSCODENM} ${view[0].CLASSSERIESCODENM} ];굴림;8;false;left";
        ctkprint_bar.prt_text_L16 = "                          - 선택1 : ${sel_sbj1};굴림;8;false;left";
        ctkprint_bar.prt_text_L18 = "                          - 선택2 : ${sel_sbj2};굴림;8;false;left";
        ctkprint_bar.prt_text_L21 = "                          - 시험일(${view[0].EXAMSTARTDATE});굴림;8;false;left";
        ctkprint_bar.prt_text_L26 = "      ${fn:substring(view[0].PRINTTIME, 0, 10)}" + ";굴림;8;false;left";
