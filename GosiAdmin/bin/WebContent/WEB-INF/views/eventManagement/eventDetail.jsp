...
<input type="hidden" id="NO" name="NO" value=""/>
    	...
    	<h2>● 사이트관리 > <strong>이벤트 관리</strong></h2>
    	...
    	<table class="table01">
		      ...
		      <tr>
		      	<th>이벤트 참여회원</th>
		      	<td td class="tdLeft" colspan="3"><c:if test="${view.MEMBER_GUBUN eq '1' }">회원+비회원</c:if><c:if test="${view.MEMBER_GUBUN ne '1' }">회원만 가능</c:if></td>
		      </tr>
		      <tr>
		      	<th>제목</th>
