...
<div id="content_pop">
    ...
    <!--테이블-->
        ...
        <c:if test="${fn:indexOf(params.BOARD_MNG_SEQ, 'NOTICE') != -1}">
	        ...
	        <c:if test="${params.BOARD_MNG_SEQ == 'NOTICE_008'}">
		        <tr>
		            ...
		            <td scope="col" style="text-align:left;">
		                ${detailView.EXAM_TYPE_NM}
		            </td>
		            <th>지역구분</th>
					<td class="tdLeft">
						${detailView.EXAM_AREA_NM}
					</td>
		        </tr>
			</c:if>
        </c:if>
        ...
        <c:if test="${params.BOARD_MNG_SEQ == 'NOTICE_000'}">
         <tr>
            <th scope="col" colspan>메인노출구분</th>
            <td scope="col" colspan="3" style="text-align:left;"><c:out value="${detailView.UPDATE_MAIN_NM}"/></td>
        </tr>
        </c:if>
        <tr>
