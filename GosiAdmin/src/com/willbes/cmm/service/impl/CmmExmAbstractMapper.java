 ...
 *  모의고사 DB(통합 전) 연동을 위해 임시로 만든 클래스
 * @author miraenet
 * @since 2015. 4. 20.
 * @version 1.0
 * @see
 ...
 *   수정일      수정자           수정내용
 *  -------    -------------    ----------------------
 *   2015. 4. 20.  miraenet        최초 생성
 * </pre>
 */
public abstract class CmmExmAbstractMapper extends EgovAbstractMapper {
