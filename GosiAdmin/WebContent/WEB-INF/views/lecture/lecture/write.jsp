  ...
  <table class="table01">
    ...
    <!-- <tr>
		...
		<tr>
          <th>강의기본배수</th>
			<td>
				<input type="radio" id="LEC_BAESU" name="LEC_BAESU" VALUE="00" checked="checked"/> 배수제한없음		
				<input type="radio" id="LEC_BAESU" name="LEC_BAESU" VALUE="15" /> 1.5배수
				<input type="radio" id="LEC_BAESU" name="LEC_BAESU" VALUE="20" /> 2배수
				<input type="radio" id="LEC_BAESU" name="LEC_BAESU" VALUE="25" /> 2.5배수
				<input type="radio" id="LEC_BAESU" name="LEC_BAESU" VALUE="30" /> 3배수
          </td>
        </tr>
	    <tr>
          <th>옵션</th>
    ...
    <tr>
      ...
      <tr>
            ...
            <td>
                <input type="radio" name="MOV_ING" value="C"  /><span class="txt03">업데이트 예정</span>
                <input type="radio" name="MOV_ING" value="I"  /><span class="txt03">업데이트중</span>
                <input type="radio" name="MOV_ING" value="E"  /><span class="txt03">업데이트 완료</span>
            </td>
      </tr> 
      <tr>
          ...
          <tr>
              ...
              <input type="text" id="SEARCHGIFT" name="SEARCHGIFT" value="${params.SEARCHTEXT}" size="40" title="검색어" onkeypress="javascript:fn_Enter1()">
...
function fn_Submit(){
  ...
  if($.trim($("#SUBJECT_MONITORMODE").val()) == ""){
		alert("화면확장모드를 입력하세요");
		$("#SUBJECT_MONITORMODE").focus();
      return;
  } 
