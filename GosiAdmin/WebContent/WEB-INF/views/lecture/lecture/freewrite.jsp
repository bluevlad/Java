...
<input type="hidden" name="GIFT_COUPON_CCODE" id="GIFT_COUPON_CCODE" value="" >
<input type="hidden" name="COUPON_NAME" id="COUPON_NAME" value="" >
<input type="hidden" name="GIFT_COUPON_CCODE" id="GIFT_COUPON_CCODE" value="" >
<input type="hidden" name="MO_COUPON_NAME" id="MO_COUPON_NAME" value="" >
<input type="hidden" name="MO_COUPON_CCODE" id="MO_COUPON_CCODE" value="" >
<input type="hidden" name="GIFT_FLAG" id="GIFT_FLAG" value="" >
...
<%--         <c:forEach items="${formlist}" var="item" varStatus="loop">
          <li>${item.NAME} <span><input name="LEARNING_CD" type="checkbox" value="${item.CODE}"/></span></li>
         	...
         	<li>입문특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_001" checked/></span></li>
            <li>테마별특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_002"  /></span></li>
           	<li>마무리특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_003"  /></span></li>
            <li>모의고사해설<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_004"  /></span></li>
            <li>기출해설특강<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_005"  /></span></li>
            <li>합격설명회<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_006"  /></span></li>
            <li>보강동영상<span class="txt03"><input type="radio" name="FREE_TAB" value="TAB_007"  /></span></li>
              </ul>
            </td>
            <td>
        <ul class="lecSerial">
  ...
  <table class="table01">
    ...
    <tr>
      <th>강의예정회차</th>
      <td>
      	총&nbsp;<input type="text" id="LEC_SCHEDULE" name="LEC_SCHEDULE" value="" size="10" maxlength="3" style="background:#FFECEC;IME-MODE:disabled;" onKeyDown="fn_OnlyNumber(this);"/> 회차&nbsp;
      	전체&nbsp;<input type="text" id="LEC_COUNT" name="LEC_COUNT" value="" size="10" maxlength="3" style="background:#FFECEC;IME-MODE:disabled;" onKeyDown="fn_OnlyNumber(this);"/> 강
     </td>
    </tr>
    <tr>
          <th>강의요약</th>
    ...
    <tr>
          ...
          <!-- <td><input type="text" id="SUBJECT_WIDE_DEFAULT_PATH" name="SUBJECT_WIDE_DEFAULT_PATH" value="mms://willbes.gscdn.com/" size="100" class="txt05" maxlength="400"/></td> -->
          <td><input type="text" id="SUBJECT_WIDE_DEFAULT_PATH" name="SUBJECT_WIDE_DEFAULT_PATH" value="http://hd2.willbes.gscdn.com/" size="100" class="txt05" maxlength="400"/></td>
...
<!--     <tr>
        ...
        <tr>
          ...
          <td><input type="text" id="SUBJECT_MP4_DEFAULT_PATH" name="SUBJECT_MP4_DEFAULT_PATH" value="http://hd2.willbes.gscdn.com/" size="100" class="txt06" maxlength="400"/></td>
        </tr>
        <tr>
          <th><span class="txt07">PMP 기본경로</span></th>
          <td><input type="text" id="SUBJECT_PMP_DEFAULT_PATH" name="SUBJECT_PMP_DEFAULT_PATH" value="mms://1.224.163.229/" size="100" class="txt07" maxlength="400"/></td>
        </tr>
    <tr>
          <th>옵션</th>
          <td>
    ...
    <tr>
		<th>플레이어 선택</th>
		<td colspan="3">
			<input type="radio" id="SUBJECT_MONITORMODE" name="SUBJECT_MONITORMODE" VALUE="NOMAL" checked="checked"/> 일반		
			<input type="radio" id="SUBJECT_MONITORMODE" name="SUBJECT_MONITORMODE" VALUE="WIDE" /> 와이드
		</td>
	</tr>    
    <tr>
          <th>개설여부</th>
      ...
      <tr>
          ...
          <tr>
              ...
              <input type="text" id="SEARCHGIFT" name="SEARCHGIFT" value="${params.SEARCHTEXT}" size="40" title="검색어" onkeypress="fn_Enter1()">
      ...
      <tr>
          ...
          <tr>
              ...
              <input type="text" id="SEARCHGIFTTEXT" name="SEARCHGIFTTEXT" value="" size="40" title="검색어" onkeypress="fn_Enter2()">
      ...
      <tr>
          ...
          <tr>
                <th width="25%">
                쿠폰명 : <input type="text" name="MO_COUPON_NAME" id="MO_COUPON_NAME" value="" size="150" readonly="readonly"> <input type="hidden" name="MO_COUPON_CCODE" id="MO_COUPON_CCODE" value="">
...
/*   if(1 > $("input[name='LEARNING_CD']:checked").size()){
  ...
  if(confirm("강의를 등록하시겠습니까?")){
    ...
    $("#frm").attr("action","<c:url value='/lecture/freesave.do' />");
    $("#frm").submit();
  }
}
