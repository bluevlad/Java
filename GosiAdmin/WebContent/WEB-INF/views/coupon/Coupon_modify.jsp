...
<div id="content">
	...
	<table class="table01">
		...
		<tr>
			...
			<th>사용여부</th>
        	<td>
        		<input type="radio"  id="IS_USE" name="IS_USE" value="Y" <c:if test="${view.IS_USE == 'Y'}">checked</c:if>/>활성&nbsp;
        		<input type="radio"  id="IS_USE" name="IS_USE" value="N" <c:if test="${view.IS_USE == 'N'}">checked</c:if>/>비활성&nbsp;
        	</td>
		</tr>
