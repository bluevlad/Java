...
<input type="hidden" id="CDATE" name="CDATE" value=""/>
	...
	<table class="table01">
		...
		<tr>
			<th>회차</th>
			<td>
				총 <input type="text" id="LEC_SCHEDULE" name="LEC_SCHEDULE" value="" size="10" maxlength="3" style="background:#FFECEC;IME-MODE:disabled;" onKeyDown="fn_OnlyNumber(this);"/> 회 강의입니다.
				&nbsp;&nbsp;[수강생 화면 제공 회차] <input type="text" id="LEC_COUNT" name="LEC_COUNT" value="" size="10" maxlength="3" style="background:#FFECEC;IME-MODE:disabled;" onKeyDown="fn_OnlyNumber(this);"/> 회
		...
		<tr>
			<th>접수상태</th>
        	<td>
				<input type="radio" name="LEC_PROCESS" value="Y" checked /><span class="txt03">접수중</span>
          		<input type="radio" name="LEC_PROCESS" value="N" /><span class="txt04">접수마감</span>
          	</td>
		</tr>
      <tr>
...
function setLecDate() {
	...
	$("#LEC_COUNT").val($("#LEC_SCHEDULE").val());
...
function fn_BookPop(type){
	window.open('<c:url value="/lectureOff/bookList.pop"/>?ADDBOOKAREA=' + type, '_blank', 'scrollbars=yes,toolbar=no,resizable=yes,width=1040,height=670');
}
