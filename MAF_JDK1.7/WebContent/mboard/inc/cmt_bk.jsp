...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td>
			<img src="${MBOARD.CPATH}/images/bullet/view_dot_01.gif" alt="" border="0" align="absmiddle">&nbsp;<strong><fmt:message bundle="${m}" key="title.board.queswrite" /> </strong>
			<c:choose>	
	...
	<c:if test="${fn:length(refList) > 0}">
		<tr>
			<td><TABLE cellspacing="0" cellpadding="2" border=0 class="table" width="100%">
				<tr>
					<td class="bbs_view_top_th" width="100"><fmt:message bundle="${m}" key="label.writer"/></td>
					<td class="bbs_view_top_th" width="356"><fmt:message bundle="${m}" key="label.title"/></td>
					<td class="bbs_view_top_th" width="120"><fmt:message bundle="${m}" key="label.regdt"/></td>
				</tr>
