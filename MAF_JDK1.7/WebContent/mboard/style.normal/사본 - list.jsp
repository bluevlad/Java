...
<c:choose>	
	<c:when test="${fn:length(list) > 0 }">
		<c:forEach items="${list}" var="data">
			...
			<tr class="bbs_td" height="20" onMouseover="this.style.backgroundColor='#f5f5f5'" onMouseout="this.style.backgroundColor='#ffffff'">
...
<form action="${pageContext.request.requestURL}" name="frmSrch" id="frmSrch" onSubmit="Search();return false;">
					<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td><select name="v_category" onchange="javascript:doSelcat(this);">
								<option value=""><fmt:message bundle="${m}" key="title.board.burrusearch"/></option>
