...
<table border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td valign="top" width="168"><div id="div_leftMenu"><jsp:include page="/WEB-INF/layout/common/wlc_menu_left.jsp" flush="true"/></div></td>
    <td valign="top"><div id="div_contents_container">
