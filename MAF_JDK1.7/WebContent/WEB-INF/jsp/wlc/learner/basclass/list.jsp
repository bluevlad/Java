        ...
        <td><div class="searchContainer">
	        ...
	        <table width="100%" border="0" cellspacing="0" cellpadding="2" class="search">
				...
				<tr>
					...
					<td><mf:select name="s_section" codeGroup="SECTION" curValue="${LISTOP.ht.s_section}"><option value=""><mfmt:message bundle="common" key="search.all"/></option></mf:select></td>					
				...
				<tr>
					...
					<td>
						<mf:input type="text" name="sjt_cd" readonly="true" value="${LISTOP.ht.sjt_cd}" onclick="CategorySelector.showList()" cssClass="dropdown" />
					...
					<td><mf:input type="text" name="s_lecname" value="${LISTOP.ht.s_lecname}" cssStyle="width:150px"/></td>					
				</tr>
	        </table>
