...
<table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">
    ...
    <tr>
        ...
        <th nowrap><mf:header name="surveyowner" /></th>
    ...
    <tr>
        <th nowrap><mf:header name="surveydesc" /></th>
    ...
    <tr>
        ...
        <td><mh:out value="${item.update_dt}" td="true"/></td>
    ...
    <tr>
        <td>
			<table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">
			    ...
			    <tr>
		        	<td colspan="4">[<c:out value="${item.usn}"/>]&nbsp;&nbsp;
