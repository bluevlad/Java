 ...
 * 
 */
public class BoardList extends MBoardAction{
...
//    	}
    	...
    	String v_srch = ( v_key.equals("") )? "" : _req.getParameter( "v_srch", listOp.get("v_srch", ""));
    	String btnAuth = "";
...
//    	logger.debug("bid:" + super.oMbbs.getBid());
    	...
    	btnAuth = MBoardAuth.getBthAuth(super.oMbbs.getBoard(), super.sessionBean, "list");
