...
public class Status extends  BaseMafCommand {
    public void process(MyHttpServletRequest request, HttpServletResponse response)
         ...
         * 
         */
//        request.setAttribute("CONFIGUREAIONS", MafConfig.getInstance().get(MafConfig.CONFIG_KEY));
		...
		String forward = request.getP("cmd","status");
        ...
        request.setAttribute("mvcPoolStatus",MvcResourcePool.getInstance().getStatus());
