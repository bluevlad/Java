...
<h2>${pageTitle} <spring:message code="title.update" /></h2>
	...
	<tbody >
		...
		<tr>
			...
			<td class="left"><input name="boxCd" type="text" value="${BoxVO.boxCd}" style="width:90%;" readonly="true"></td>
		</tr>
		<!-- 사물함명칭 -->
		<c:set var="title"><spring:message code="box.boxNm"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="boxNm" type="text" value="${BoxVO.boxNm}" style="width:90%;"></td>
		</tr>
		<!-- 사물함갯수 -->
		<c:set var="title"><spring:message code="box.boxCount"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="boxCount" type="text" value="${BoxVO.boxCount}" style="width:90%;"></td>
		</tr>
		<!-- 층수 -->
		<c:set var="title"><spring:message code="box.rowCount"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="rowCount" type="text" value="${BoxVO.rowCount}" style="width:90%;"></td>
		</tr>
		<!-- 가로갯수 -->
		<c:set var="title"><spring:message code="box.rowNum"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="rowNum" type="text" value="${BoxVO.rowNum}" style="width:90%;"></td>
		</tr>
		<!-- 가로갯수 -->
		<c:set var="title"><spring:message code="box.boxPrice"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="boxPrice" type="text" value="${BoxVO.boxPrice}" style="width:90%;"></td>
		</tr>
		<!-- 가로갯수 -->
		<c:set var="title"><spring:message code="box.deposit"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="deposit" type="text" value="${BoxVO.deposit}" style="width:90%;"></td>
		</tr>
		<!-- 가로갯수 -->
		<c:set var="title"><spring:message code="box.startNum"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="startNum" type="text" value="${BoxVO.startNum}" style="width:90%;"></td>
		</tr>
		<!-- 가로갯수 -->
		<c:set var="title"><spring:message code="box.endNum"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left"><input name="endNum" type="text" value="${BoxVO.endNum}" style="width:90%;"></td>
		</tr>
	</tbody>
	</table>
<br>
