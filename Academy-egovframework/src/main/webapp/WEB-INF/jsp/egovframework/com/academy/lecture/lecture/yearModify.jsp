...
function fn_SubjectPop(type){
	window.open('<c:url value="/lecture/subjectList.pop"/>?ADDAREA=' + type + '&LEC_TYPE_CHOICE=${params.LEC_TYPE_CHOICE}', '_blank', 'scrollbars=no,toolbar=no,resizable=yes,width=1040,height=670');
}
