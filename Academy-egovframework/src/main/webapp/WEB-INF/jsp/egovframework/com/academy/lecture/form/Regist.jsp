...
function fn_save(){
	...
	if(confirm("<spring:message code='common.save.msg' />")){
		varFrom.action =  "<c:url value='/academy/lecture/form/Insert.do' />";
		varFrom.submit();
	}
}
</script>
...
<h2>${pageTitle} <spring:message code="title.update" /></h2>
	...
	<tbody >
		...
		<tr>
			...
			<td class="left" colspan="3"><input name="formCode" type="text" value="" style="width:90%;"></td>
		</tr>
		<!-- 학습형태명 -->
		<c:set var="title"><spring:message code="lec.formName"/></c:set>
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left" colspan="3"><input name="formName" type="text" value="" style="width:90%;"></td>
		</tr>
		<!-- 사용여부 -->
