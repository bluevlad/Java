...
/* 온라인 모의고사 관련 테이블 시작 */
CREATE TABLE ACM_SUBJECT_MST (
	SBJ_CD    	INT NOT NULL,
	SBJ_NM		VARCHAR(100) NOT NULL,
	ISUSE   	CHAR(1) NOT NULL,
	PRIMARY KEY (SBJ_CD)
);

CREATE UNIQUE INDEX ACM_SUBJECT_MST_PK ON ACM_SUBJECT_MST (
	SBJ_CD
);

CREATE TABLE ACM_EXAM_MST (
	EXAM_CD    	INT NOT NULL,
	EXAM_NM		VARCHAR(100) NOT NULL,
	ISUSE   	CHAR(1) NOT NULL,
	PRIMARY KEY (EXAM_CD)
);

CREATE UNIQUE INDEX ACM_EXAM_MST_PK ON ACM_EXAM_MST (
	EXAM_CD
);
...
CREATE UNIQUE INDEX ACM_EXAM_SUBJECT_PK ON ACM_EXAM_SUBJECT (
	EXAM_CD, SBJ_CD
);
/* 온라인 모의고사 관련 테이블 종료 */
...
(
	...
	FOREIGN KEY EMPLYR_INFO_FK2 (ORGNZT_ID) REFERENCES COMTNORGNZTINFO(ORGNZT_ID)
		ON DELETE SET NULL,
	FOREIGN KEY EMPLYR_INFO_FK1 (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID)
		ON DELETE SET NULL
)
;
...
CREATE UNIQUE INDEX EMPLYR_INFO_PK ON EMPLYR_INFO
(
	EMPLYR_ID
)
;
...
CREATE INDEX EMPLYR_INFO_i01 ON EMPLYR_INFO
(
	ORGNZT_ID
)
;
...
CREATE INDEX EMPLYR_INFO_i02 ON EMPLYR_INFO
(
	GROUP_ID
)
;
...
CREATE UNIQUE INDEX SYS_LOG_PK ON SYS_LOG
(
	REQUST_ID
)
;
...
CREATE UNIQUE INDEX BACKUP_OPERT_PK ON BACKUP_OPERT
(
	BACKUP_OPERT_ID
)
;
...
(
	...
	FOREIGN KEY COMTNBACKUPSCHDULDFK_FK1 (BACKUP_OPERT_ID) REFERENCES BACKUP_OPERT(BACKUP_OPERT_ID)
)
;
...
(
	...
	FOREIGN KEY CMMN_DETAIL_CODE_FK1 (CODE_ID) REFERENCES COMTCCMMNCODE(CODE_ID)
)
;



CREATE UNIQUE INDEX CMMN_DETAIL_CODE_PK ON CMMN_DETAIL_CODE
(
	CODE_ID,
	CODE
)
...
CREATE INDEX CMMN_DETAIL_CODE_i01 ON CMMN_DETAIL_CODE
(
	CODE_ID
)
;
...
(
	...
	FOREIGN KEY ENTRPRS_MBER_FK1 (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID)
		ON DELETE SET NULL
)
;
...
CREATE UNIQUE INDEX ENTRPRS_MBER_PK ON ENTRPRS_MBER
(
	ENTRPRS_MBER_ID
)
;
...
CREATE INDEX ENTRPRS_MBER_i01 ON ENTRPRS_MBER
(
	GROUP_ID
)
;
...
(
	...
	CHG_PWD_LAST_PNTTM    DATETIME NULL,
	 PRIMARY KEY (MBER_ID),
	FOREIGN KEY GNRL_MBER_FK1 (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID)
		ON DELETE SET NULL
)
;
...
CREATE UNIQUE INDEX GNRL_MBER_PK ON GNRL_MBER
(
	MBER_ID
)
;
...
CREATE INDEX GNRL_MBER_i01 ON GNRL_MBER
(
	GROUP_ID
)
;
...
CREATE UNIQUE INDEX AUTHOR_INFO_PK ON AUTHOR_INFO
(
	AUTHOR_CODE
)
;
...
CREATE UNIQUE INDEX EMPLYRSCRTYESTBS_PK ON EMPLYRSCRTYESTBS
(
...
CREATE INDEX EMPLYRSCRTYESTBS_i04 ON EMPLYRSCRTYESTBS
(
	AUTHOR_CODE
)
;
...
(
	...
	FOREIGN KEY ROLES_HIERARCHY_FK1 (PARNTS_ROLE) REFERENCES AUTHOR_INFO(AUTHOR_CODE)
		ON DELETE CASCADE,
	FOREIGN KEY ROLES_HIERARCHY_FK2 (CHLDRN_ROLE) REFERENCES AUTHOR_INFO(AUTHOR_CODE)
		ON DELETE CASCADE
)
;
...
CREATE UNIQUE INDEX ROLES_HIERARCHY_PK ON ROLES_HIERARCHY
(
	PARNTS_ROLE,
	CHLDRN_ROLE
)
...
CREATE UNIQUE INDEX ROLES_HIERARCHY_i01 ON ROLES_HIERARCHY
(
	PARNTS_ROLE
)
;
...
CREATE INDEX ROLES_HIERARCHY_i02 ON ROLES_HIERARCHY
(
	CHLDRN_ROLE
)
;
...
CREATE UNIQUE INDEX ROLE_INFO_PK ON ROLE_INFO
(
	ROLE_CODE
)
;
...
(
	...
	FOREIGN KEY AUTHOR_ROLE_RELATE_FK1 (AUTHOR_CODE) REFERENCES AUTHOR_INFO(AUTHOR_CODE)
		ON DELETE CASCADE,
	FOREIGN KEY AUTHOR_ROLE_RELATE_FK2 (ROLE_CODE) REFERENCES ROLE_INFO(ROLE_CODE)
		ON DELETE CASCADE
)
;
...
CREATE UNIQUE INDEX AUTHOR_ROLE_RELATE_PK ON AUTHOR_ROLE_RELATE
(
	AUTHOR_CODE,
	ROLE_CODE
)
...
CREATE INDEX AUTHOR_ROLE_RELATE_i01 ON AUTHOR_ROLE_RELATE
(
	AUTHOR_CODE
)
;
...
CREATE INDEX AUTHOR_ROLE_RELATE_i02 ON AUTHOR_ROLE_RELATE
(
	ROLE_CODE
)
;
...
CREATE UNIQUE INDEX WEB_LOG_PK ON WEB_LOG
(
	REQUST_ID
)
;
...
CREATE UNIQUE INDEX USER_SUMMARY_PK ON USER_SUMMARY
(
	OCCRRNC_DE,
	STATS_SE,
	DETAIL_STATS_SE
...
(
	...
	FOREIGN KEY COMTNMENUCREATDTLS_FK3 (MAPNG_CREAT_ID) REFERENCES COMTNSITEMAP(MAPNG_CREAT_ID)
		ON DELETE CASCADE,
	FOREIGN KEY COMTNMENUCREATDTLS_FK1 (AUTHOR_CODE) REFERENCES AUTHOR_INFO(AUTHOR_CODE)
)
;
...
(
	...
	FOREIGN KEY COMTHEMPLYRINFOCHANGEDTLS_FK1 (EMPLYR_ID) REFERENCES EMPLYR_INFO(EMPLYR_ID)
)
;
...
CREATE UNIQUE INDEX BATCH_OPERT_PK ON BATCH_OPERT
(
	BATCH_OPERT_ID
)
;
...
CREATE UNIQUE INDEX BATCH_SCHDUL_PK ON BATCH_SCHDUL
(
	BATCH_SCHDUL_ID
)
;
...
(
	...
	FOREIGN KEY BATCH_SCHDUL_DFK_FK1 (BATCH_SCHDUL_ID) REFERENCES BATCH_SCHDUL(BATCH_SCHDUL_ID)
)
;



CREATE UNIQUE INDEX BATCH_SCHDUL_DFK_PK ON BATCH_SCHDUL_DFK
(
	BATCH_SCHDUL_ID,
	EXECUT_SCHDUL_DFK_SE
)
...
CREATE UNIQUE INDEX COP_SEQ_PK ON COP_SEQ
(
	TABLE_NAME
)
;
