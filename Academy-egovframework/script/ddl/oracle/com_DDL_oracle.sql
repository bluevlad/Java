...
CONSTRAINT  EMPLYR_INFO_PK PRIMARY KEY (EMPLYR_ID),
CONSTRAINT  EMPLYR_INFO_FK2 FOREIGN KEY (ORGNZT_ID) REFERENCES COMTNORGNZTINFO(ORGNZT_ID) ON DELETE CASCADE,
CONSTRAINT  EMPLYR_INFO_FK1 FOREIGN KEY (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID) ON DELETE CASCADE
);
...
CONSTRAINT  COMTNBACKUPSCHDULDFK_FK1 FOREIGN KEY (BACKUP_OPERT_ID) REFERENCES BACKUP_OPERT(BACKUP_OPERT_ID)
);
...
(
	...
	LAST_UPDT_PNTTM       DATE  NULL ,
	LAST_UPDUSR_ID        VARCHAR2(20)  NULL ,
CONSTRAINT  CMMN_DETAIL_CODE_PK PRIMARY KEY (CODE_ID,CODE),
CONSTRAINT  CMMN_DETAIL_CODE_FK1 FOREIGN KEY (CODE_ID) REFERENCES COMTCCMMNCODE(CODE_ID)
);
...
CONSTRAINT  ENTRPRS_MBER_FK1 FOREIGN KEY (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID) ON DELETE CASCADE
);
...
CONSTRAINT  GNRL_MBER_FK1 FOREIGN KEY (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID) ON DELETE CASCADE
);
...
CONSTRAINT  AUTHOR_INFO_PK PRIMARY KEY (AUTHOR_CODE)
);
...
CONSTRAINT  ROLES_HIERARCHY_FK1 FOREIGN KEY (PARNTS_ROLE) REFERENCES AUTHOR_INFO(AUTHOR_CODE) ON DELETE CASCADE,
CONSTRAINT  ROLES_HIERARCHY_FK2 FOREIGN KEY (CHLDRN_ROLE) REFERENCES AUTHOR_INFO(AUTHOR_CODE) ON DELETE CASCADE
);
...
CONSTRAINT  ROLE_INFO_PK PRIMARY KEY (ROLE_CODE)
);
...
CONSTRAINT  AUTHOR_ROLE_RELATE_FK1 FOREIGN KEY (AUTHOR_CODE) REFERENCES AUTHOR_INFO(AUTHOR_CODE) ON DELETE CASCADE,
CONSTRAINT  AUTHOR_ROLE_RELATE_FK2 FOREIGN KEY (ROLE_CODE) REFERENCES ROLE_INFO(ROLE_CODE) ON DELETE CASCADE
);
...
CONSTRAINT  COMTNMENUCREATDTLS_FK1 FOREIGN KEY (AUTHOR_CODE) REFERENCES AUTHOR_INFO(AUTHOR_CODE)
);
...
CONSTRAINT  COMTHEMPLYRINFOCHANGEDTLS_FK1 FOREIGN KEY (EMPLYR_ID) REFERENCES EMPLYR_INFO(EMPLYR_ID)
);
...
AS  SELECT ESNTL_ID, MBER_ID,PASSWORD,MBER_NM,ZIP,ADRES,MBER_EMAIL_ADRES,' ','GNR' AS USER_SE, ' ' ORGNZT_ID
	...
	UNION ALL
		...
		FROM ENTRPRS_MBER ORDER BY ESNTL_ID;
...
CONSTRAINT  COP_SEQ_PK PRIMARY KEY (TABLE_NAME)
);
