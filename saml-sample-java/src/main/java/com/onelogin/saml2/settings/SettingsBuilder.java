...
public class SettingsBuilder {
	...
	public SettingsBuilder fromFile(String propFileName) throws Error {
		try  {
//			LOGGER.error("propFileName" + propFileName);
			System.out.println("propFileName" + propFileName);
			propFileName = "D:\\eclipse-workspace\\saml-test\\src\\main\\resources\\" + propFileName;
	...
	private void loadIdpSetting() {
		...
		if (idpCertFingerprintAlgorithm != null && !Objects.isEmpty(idpCertFingerprintAlgorithm))
	...
	private void loadSecuritySetting() {
		...
		if (requestedAuthnContextComparison != null && !Objects.isEmpty(requestedAuthnContextComparison))
		...
		if (signatureAlgorithm != null && !Objects.isEmpty(signatureAlgorithm))
	...
	private List<Contact> loadContacts() {
		...
		if ((technicalGn != null && !Objects.isEmpty(technicalGn)) || (technicalEmailAddress != null && !Objects.isEmpty(technicalEmailAddress))) {
		...
		if ((supportGn != null && !Objects.isEmpty(supportGn)) || (supportEmailAddress != null && !Objects.isEmpty(supportEmailAddress))) {
	...
	private void loadSpSetting() {
		...
		if (spNameIDFormat != null && !Objects.isEmpty(spNameIDFormat))
	 ...
	 * @throws Exception 
	 */
	protected X509Certificate loadCertificateFromProp(Object propValue) throws Exception {
	...
	protected X509Certificate loadCertificateFromProp(String propertyKey) {
		...
		try {
			cert = loadCertificateFromProp(samlData.get(propertyKey));
		} catch (Exception e) {
	...
	*/
	private void parseProperties(Properties properties) {
		if (properties != null) {
		    ...
		    while (e.hasMoreElements()) {
				...
				this.samlData.put(key, properties.getProperty(key));
		      }
		}
	}
	...
	public SettingsBuilder fromFile(String string, KeyStoreSettings keyStoreSettings) {
		// TODO Auto-generated method stub
		return null;
	}

	public SettingsBuilder fromValues(Map<String, Object> samlData2, KeyStoreSettings keyStoreSettings) {
		// TODO Auto-generated method stub
		return null;
	}
}
