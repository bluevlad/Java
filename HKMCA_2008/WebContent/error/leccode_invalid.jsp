...
<table width="584" height="35" border="0" cellspacing="3" cellpadding="0" align="center" bgcolor="#EBEBEB">
    <TR>
        <TD bgColor=#ffffff>
            <table width="578" border="0" cellspacing="0" cellpadding="0">
                <TR>
                    <td align="center"><a href='<c:url value="/wlc.tutor/main.do"/>'><mfmt:message bundle="common" key="login.role.prf" /></a></td>
                    <td align="center"><a href='<c:url value="/wlc.learner/main.do"/>'><mfmt:message bundle="common" key="login.role.std" /></a></td>
                </TR>
            </TABLE>
        </TD>
    </TR>
