...
function setRetry() {
    ...
    var params={<c:out value="'cmd':'setRetry','exmid':'${param.exmid}','usn':'${uitem.usn}'" escapeXml="false"/>};
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="view"> 
    ...
    <tr>
        <th><mfmt:message bundle="etest.common" key="result.rst_fullscore" /></th>
        <td><mh:out value="${uitem.rst_fullscore}" td="true"/></td>
        <th><mfmt:message bundle="etest.common" key="result.rstscore" /></th>
        <td><mh:out value="${uitem.rstscore}" td="true"/></td>
    </tr>
    <tr>
...
<table border="0" cellpadding="2" cellspacing="0" class="viewBtn" width="100%">
    <tr>
        <td align="right">
            <mf:button bundle="button" key="etest.retry" onclick="setRetry();" />
            <mf:button bundle="button" key="etest.continue" onclick="setContinue();" />
