        ...
        <td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="search">
                ...
                <tr>
                    ...
                    <td colspan="3"><mf:input name="s_quetitle" type="text" cssStyle="width:98%" value="${LISTOP.ht.s_quetitle}" /></td>
                </tr>
                <tr>
                    <th><mf:label name="quetype" /></th>
                    <td>
                        <mf:select name="s_quetype" codeGroup="ETEST.QTYPE" curValue="${LISTOP.ht.s_quetype}">
                            <mf:option value="">전체</mf:option>
                        </mf:select>
                    </td>
                    <th><mf:label name="quelevel" /></th>
                    <td>
                        <mf:select name="s_quelevel" codeGroup="ETEST.QLEVEL" curValue="${LISTOP.ht.s_quelevel}">
                            <mf:option value="">전체</mf:option>
                        </mf:select>
                    </td>
                </tr>
            ...
            <tbody>
                <c:forEach var="item" items="${navigator.list}" varStatus="status">
                    <tr>
                        ...
                        <td align="center"><mf:button bundle="button" key="etest.translate" onclick="doViewLang('${item.queid}')" /></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
