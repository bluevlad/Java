...
<c:choose>
    ...
    <tr>
        ...
        <td><jh:out value="${item.quetype}" codeGroup="ETEST.QTYPE"/></td>
        <th><mf:label name="quecount"/></th>
        <td><mfmt:message bundle="table.exm_bnk" key="quecount"><jh:out value="${item.quecount}"/></mfmt:message></td>
    </tr>
    <tr>
        <th height="28"><mf:label name="quelevel"/></th>
        <td><jh:out value="${item.quelevel}" codeGroup="ETEST.QLEVEL"/></td>
        <th><mf:label name="active_yn"/></th>
        <td><jh:out value="${item.active_yn}" codeGroup="ACTIVE_YN"/></td>
    </tr>
    <tr>
        <th height="28"><mf:label name="quescore"/></th>
        <td><jh:out value="${item.quescore}"/><mfmt:message bundle="common" key="etest.score"/></td>
        <th>Language</th>
...
<table border="0" cellpadding="2" cellspacing="1" class="view" width="100%"> 
    ...
    <tr>
        ...
        <td>
	        <div class="simplebox"><jh:out value="${item.quetitle}"/></div>
    ...
    <tr>
        ...
        <td>
	        <div class="simplebox"><jh:out value="${item.quetext}"/></div>
    ...
    <tr>
        ...
        <td>
            ...
            <br><a href='<c:out value="${iurl}"/>' target='_blank'><jh:out value="${langItem.queimag}"/></a>&nbsp;&nbsp;<input type="checkbox" name="queimag_flag" style="border:none" value="Y" checked >:<mfmt:message bundle="common.message" key="message.use_file"/><br>
            </c:if>
            <c:if test="${!empty item.queimag}">
            <c:url var="iurl" value="/wdownload">
                <c:param name="type" value="exam_file"/>
            ...
            <br><a href='<c:out value="${iurl}"/>' target='_blank'><jh:out value="${item.queimag}"/></a><br>
            </c:if>
        </td>
    </tr>
    </c:if>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw1}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw2}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw3}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw4}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw5}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw6}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw7}"/></div>
    ...
    <tr>
        ...
        <td colspan="2"><div class="simplebox"><jh:out value="${item.queviw8}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox" ><jh:out value="${item.queviw9}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.queviw10}"/></div>
    ...
    <c:if test="${!(item.quetype == 's' || item.quetype == 'm')}">
        ...
        <td>
            <div class="simplebox"><jh:out value="${item.queansw}"/></div>
    ...
    <c:if test="${item.quetype == 's' || item.quetype == 'm'}">
    <th><mf:label name="queansw"/></th>
        <td><div class="simplebox"><jh:out value="${item.queansw}"/></div>
    ...
    <tr>
        ...
        <td><div class="simplebox"><jh:out value="${item.quedesc}"/></div>
