...
<table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">    
    ...
    <tr>
        ...
        <td>
            <mf:input type="text" name="prd_cd" readonly="true" cssStyle="width:50px" value="${item.prd_cd}" onclick="doPrdSearch('myform','prd_cd')"/>
            <mf:input type="text" name="prd_nm" cssStyle="width:170px" value="${item.psell_nm}"/>
        </td>
    ...
    <tr>
        ...
        <td colspan="3"><textarea style="width:95%" rows=3 name="psell_desc"><mh:out value="${item.psell_desc}"/></textarea></td>
    </tr>
</table>
