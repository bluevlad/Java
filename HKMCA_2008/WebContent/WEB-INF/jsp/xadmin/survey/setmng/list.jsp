        ...
        <div class="searchContainer">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="search">
                ...
                <tr>
                    ...
                    <td><mf:input type="text" name="s_settitle" cssStyle="width:98%" value="${LISTOP.ht.s_settitle}" /></td>
                </tr>
            </table>
    ...
    <tr>
        <td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="viewBtn">     
			    <tr>
			        <td align="right" height="30"><mf:button bundle="button" key="add" onclick="doWrite()" icon="icon_add" /></td>
			    </tr>
			</table>
	        </div>
        </td>
