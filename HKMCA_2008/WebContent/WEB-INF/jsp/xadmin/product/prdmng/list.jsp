        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list" enableAlternateRows="true" rowAlternateClass="alternateRow">
            <thead>
                <tr>
                    ...
                    <th><mf:header name="cat_nm" sort="true" /></th>
                    <th><mf:header name="prd_price" sort="true" /></th>
                </tr>
            </thead>
            <tbody>
                <c:forEach var="item" items="${navigator.list}" varStatus="status">
                    <tr>
                        ...
                        <td><a href="javaScript:doEdit('<c:out value="${item.prd_cd}"/>')" /><mh:out value="${item.prd_nm}" td="true" /></a></td>
                        <td align="center"><mh:out value="${item.cat_nm}" td="true" /></td>
                        <td align="center"><mh:out value="${item.prd_price}" format="currency" /></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
