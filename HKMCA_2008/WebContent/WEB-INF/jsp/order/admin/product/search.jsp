...
<!--
	function doSelect(prd_cd, prd_nm) {
            ...
            <tbody>
                <c:forEach var="item" items="${navigator.list}" varStatus="status">
                    <tr>
                        ...
                        <td align="center"><a href="javascript:doSelect('<mh:out value="${item.prd_cd}"/>','<mh:out value="${item.prd_nm}"/>')"><mh:out value="${item.prd_nm}" td="true" /></a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
