...
<table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">	
	...
	<tr>
	    ...
	    <td><mf:input type="text" name="prd_cd" cssStyle="width:95%" readonly="true" value="${item.prd_cd}"/></td>
        <th><mf:label name="prd_nm"/></th> 
        <td><mf:input type="text" name="prd_nm" cssStyle="width:95%" required="true" value="${item.prd_nm}"/></td>
 	</tr>
    <tr>
        <th><mf:label name="prd_price"/></th> 
        <td><mf:input type="text" name="prd_price" cssStyle="width:100px" value="${item.prd_price}"/></td>
