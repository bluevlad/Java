        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2" class="list" enableAlternateRows="true" rowAlternateClass="alternateRow">
            ...
            <tbody>
                <c:forEach var="item" items="${navigator.list}" varStatus="status">
                    <tr>
                        <td align="center"><jh:listseq navigator="${navigator}" count="${status.count}" /></td>
                        <td align="center"><a href="javaScript:doEdit('<c:out value="${item.prd_cd}"/>')" /><jh:out value="${item.prd_cd}" td="true" /></a></td>
                        <td align="center"><a href="javaScript:doEdit('<c:out value="${item.prd_cd}"/>')" /><jh:out value="${item.prd_nm}" td="true" /></a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
