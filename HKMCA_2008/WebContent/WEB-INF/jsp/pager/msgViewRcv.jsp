...
<table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">	
	...
	<col width="35%"/>
	<tr>
	    <th><mfmt:message bundle="pager" key="msg_snd_usn"/></th> 
	    <td><mh:out value="${item.msg_snd_nm}" td="true"/>(<mh:out value="${item.msg_snd_id}" td="true"/>)</td>
...
<table border="0" cellpadding="2" cellspacing="1" width="100%" class="viewBtn">     
    <tr>
        <td align="right">
            <mf:button bundle="button" key="pager.reply" onclick="doReply()"/>
            <mf:button bundle="button" key="pager.delete" onclick="doDelete()"/>
        </td>
    </tr>
</table>
</mf:form>