        ...
        <div class="searchContainer">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><mf:input type="text" name="s_prd_cd" value="${LISTOP.ht.s_prd_cd}" cssStyle="width:95%" /></td>
                    <th><mf:label name="prd_nm" for="s_prd_nm" /></th>
                    <td><mf:input type="text" name="s_prd_nm" value="${LISTOP.ht.s_prd_nm}" cssStyle="width:95%" /></td>
                </tr>
            </table>
	            ...
	            <tbody>
	                <c:forEach var="item" items="${navigator.list}" varStatus="status">
	                    <tr>
	                        ...
	                        <td><a href="javascript:doSelect('<mh:out value="${item.prd_cd}"/>','<mh:out value="${item.prd_nm}"/>','<mh:out value="${item.org_price}"/>')"><mh:out value="${item.prd_nm}" td="true" /></a></td>
	                    </tr>
	                </c:forEach>
	            </tbody>
	        </table>
