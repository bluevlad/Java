...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td>
            <br>
            <form action="${controlaction}" method="get" name="search">
            <mf:input type="text" name="sch_sdt" size="20" maxlength="8" onclick="popUpCalendar(this, this, 'yyyymmdd');" value="" cssClass="dropdown"/> -
            <mf:input type="text" name="sch_edt" size="20" maxlength="8" onclick="popUpCalendar(this, this, 'yyyymmdd');" value="" cssClass="dropdown"/> 
