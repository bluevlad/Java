					...
					<td valign="top">
					    ...
					    <tbody>
							...
							<tr>
								...
								<td class="center"><mh:out value="${item.sex}" td="true"/></td>
								<td class="center"><mh:out value="${item.cnt}" td="true"/></td>
							</tr>
                            <script type="text/javascript">
                            tdata = tdata + "<set label='<c:out value="${item.sex}"/>' value='<c:out value="${item.cnt}"/>'/>";
                            </script>
						    ...
						    <tr>
						        <td align="center">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        data = "<chart caption='성별구분' xAxisName='' yAxisName='' showValues='1' decimals='0' formatNumberScale='0'>";
                                        data = data + tdata;
                                        data = data + "</chart>";
