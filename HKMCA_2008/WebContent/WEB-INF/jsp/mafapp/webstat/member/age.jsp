					...
					<td valign="top">
					    ...
					    <tbody>
							...
							<tr>
								...
								<td class="center"><mh:out value="${item.age}" td="true"/></td>
								<td class="center"><mh:out value="${item.cnt}" td="true"/></td>
							</tr>
                            <script type="text/javascript">
                            tdata = tdata + "<set label='<c:out value="${item.age}"/>' value='<c:out value="${item.cnt}"/>'/>";
                            </script>
						    ...
						    <tr>
						        <td align="center">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        data = "<chart caption='나이구분' xAxisName='' yAxisName='' showValues='1' decimals='0' formatNumberScale='0'>";
                                        data = data + tdata;
                                        data = data + "</chart>";
