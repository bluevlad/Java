...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
        <td>
            ...
            <c:forEach var="item" items="${pkColumns}" varStatus="status">
                <input type='hidden' name='<mh:out value="${item.name}" case="lower"/>' value=''>
			</c:forEach> 
				...
				<c:forEach var="item" items="${searchColumnsList}" varStatus="status">			
                    <tr>
						...
						<td><input type="text" name="s_<mh:out value="${item.name}" case="lower"/>" value="${LISTOP.ht.s_<mh:out value="${item.name}" case="lower"/>}"></td>
                    </tr>
				</c:forEach>
                </table>
