...
<form action="${control_action}" method="post" name="myform" id="myform" >
    ...
    <tr>
        ...
        <tr>
          <th width="20">No</th>
          <th><mfmt:message bundle="table.Wlcexmmst" key="wlc_exm_mst.exmtitle"/></th>
          <th><mfmt:message bundle="table.Wlcexmmst" key="wlc_exm_mst.exm_date"/></th>
          <th><mfmt:message bundle="table.Wlcexmmst" key="wlc_exm_mst.exmrate"/></th>
          <th><mfmt:message bundle="table.Wlcexmrst" key="wlc_exm_rst.rstatscore2"/></th>
          <th><mfmt:message bundle="table.Wlcexmrst" key="wlc_exm_rst.rstmtscore"/></th>
          <th><mfmt:message bundle="table.Wlcexmrst" key="wlc_exm_rst.rstoffscore1"/></th>
          <th><mfmt:message bundle="common" key="table.score"/></th>
          <th><mfmt:message bundle="table.Wlcexmrst" key="wlc_exm_rst.rst_sdate"/></th>
        </tr>
        </thead>
        <tbody>
