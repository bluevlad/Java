...
<script language="javascript">
    ...
    function test_finish() {
        if (confirm('<mfmt:message bundle="etest.common" key="message.exm.end"/>')) {
            sendFinish() ;
        }
    }
    function sendFinish() {
...
//                            window.opener.document.location.reload();
                            window.opener.document.location = "/wlc.learner/examlist.do";
                            window.close();
                        }
                      }
                ); 
    ...
    function doFin(sel){
        ...
        if(sel==1){
            ...
            alert('<mfmt:message bundle="etest.common" key="warning.exm.8"/>');
         }    
        if(sw){
            sendFinish() ;
        }
...
<table width="850" border="0" cellspacing="0" cellpadding="0" style="height:26px;color:#E6E6E6;background:#595959;border-bottom:1px solid #000000;">
    <tr>
        ...
        <td align="right">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td><mf:button bundle="button" key="etest.end" onclick="test_finish()"/></td>
                    <td width="10"></td>
                </tr>
            </table>
        </td>
                    ...
                    <td bgcolor="FBFCFE" style="border-top:1px solid #E6E6E6; padding:10px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                // 문제 유형별로 답안 입력 부문 표시 
                    		    if (Etest.QUE_TYPE_MULTI.equals(view.getQtype()) || Etest.QUE_TYPE_SINGLE.equals(view.getQtype())) {
