...
<table border="0" cellpadding="2" cellspacing="0" class="view" width="70%" align="Center">
    <tr>
        <td align="center" height="100">이 Lecture에는 설정된 E-Test가 없습니다. 개설과목관리에서 시험을 선택해 주시기 바랍니다.</td>
    </tr>
</table>
</c:when>
<c:otherwise>
...
<table border="0" cellpadding="2" cellspacing="0" class="viewBtn" width="100%">
    <tr>
        <td align="right"><mf:button bundle="etest.button" key="table.exm.create" onclick="frmSubmit('myform')" /></td>
    </tr>
</table>
</mf:form>
</c:otherwise>
