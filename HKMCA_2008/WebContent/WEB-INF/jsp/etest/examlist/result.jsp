...
<table border="0" cellpadding="2" cellspacing="0" class="view" width="100%">
    ...
    <col width="30%" />
    <tr>
        <th><mfmt:message bundle="etest.common" key="result.qcnt" /></th>
        <td align="center"><mh:out value="${item.qcnt}" /></td>
        <th><mfmt:message bundle="etest.common" key="result.rstscore" /> / <mfmt:message bundle="etest.common" key="result.qsum" /></th>
    ...
    <tr>
        ...
        <th><mfmt:message bundle="etest.common" key="result.rstrank" /></th>
    ...
    <tr>
        ...
        <th><mfmt:message bundle="etest.common" key="result.rstrank100" /></th>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="no_border">
    <tr>
        <td align="center"><div id="chartdiv" align="center"> 
            ...
            var chart = new FusionCharts("Column3D.swf", "ChartId", "100%", "400", "0", "0");
...
<table border="0" cellpadding="2" cellspacing="0" class="viewBtn" width="100%">
    <tr>
        <td align="right"><mf:button bundle="button" key="list" onclick="goList();" /></td>
    </tr>
</table>