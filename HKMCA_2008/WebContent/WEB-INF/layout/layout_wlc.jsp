...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td valign="top" width="180">
            <div id="div_leftMenu">
            <jsp:include page="/WEB-INF/layout/common/menu_left_wlc.jsp" flush="true"/>
            <jsp:include page="/WEB-INF/layout/common/wlc_board.jsp" flush="true"/>
            </div>
        </td>
        <td valign="top">
            <div id="div_contents_container">
                <div id="div_title_container">
                    ...
                    <div class="help"><img src='<c:url value="/jmf_images/button_icon/search.gif"/>' border="0" onclick="popHelp('<jh:out value="${JMF_INFO.pgid}"/>');"/></div>
