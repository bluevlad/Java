...
<!-- CLOSE BAR START -->
<table width="500" border="0" cellspacing="0" cellpadding="0" class="popup">
    <tr>
        <td>
            <c:catch var="error">
    ...
    <tr>
        <td>
            <!-- CLOSE BAR START -->
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px" class="no_border">
			    <tr>
