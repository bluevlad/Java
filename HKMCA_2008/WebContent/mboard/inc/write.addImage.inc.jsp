    ...
    <td class="bbs_view_td" style="padding:5 10 0 0;">
        <table border="0" cellpadding="2" cellspacing="0" width="100%">
            <tr valign="top" class="td">
                <td width="100"><input type='button' onclick='createFileObj()' value='<mfmt:message bundle="${m}" key="title.board.countadd" />'></td>
                <td id="filesDiv" width="*">
                    <div id="filelist0" style="padding-bottom:4px;">
                    <input type="file" name="file0" id="file0" style="width:500px;">&nbsp;&nbsp;
                    <input type='button' onclick='removeFileObj(0)' value='delete'/>
                    </div>
                </td>
            </tr>
        </table>
...
<!--  tr valign="top">
    ...
    <td style="padding:5 10 10 0;">
        ...
        <script language="JavaScript1.2" src='<c:out value="${MBOARD.PATH}"/>/js/writeList.js'></script>
    </td>
</tr-->