...
<script type="text/javascript" src='/hkmca/js/ext/ext-prototype-adapter.js'></script>
<script type="text/javascript" src='/hkmca/js/ext-all.js'></script>
<link rel="stylesheet" type="text/css" href="/hkmca/js/ext/ext-all.css" />
</head>
<body>
<style>
...
<a href="javascript:OrgSetter.sync('A02AA.2170')">setup (A02AA.2170)</a>
