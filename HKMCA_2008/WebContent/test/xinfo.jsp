...
<hr>
chkvalue01 : [<jh:out value="${chkvalue01}" />]<br>
chkvalue02 : [<jh:out value="${chkvalue02}" td="true"/>]<br>
function Check : <br>
<c:set var="str" value="012345"/>
<jh:length var="t" value="${str}"/>
length of String(EL)  : <c:out value="${str}"/> [<jh:out value="${t}"/>]<br/>
length of direct String(012345) : [<jh:length  value="012345"/>]<br/>
<jh:length var="t" value="${map}"/>
Map : [<jh:out value="${t}"/>]<jh:out value="${map}"/><br>
<jh:length var="t" value="${list}"/>
list : [<jh:out value="${t}"/>]<jh:out value="${list}"/>
<hr>
