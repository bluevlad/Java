...
//		         "-//UBQ//DTD maf-command config XML V1.0//EN"
//		         "resourceBundle.dtd">
...
//		desc 	CDATA #IMPLIED 
		...
		try {
			...
			xw.setDocType(" maf-command PUBLIC \"-//UBQ//DTD maf-command config XML V1.0//EN\"  \"resourceBundle.dtd\" ");
			xw.startTag("bundle");
...
//        "resourceBundle.dtd"
		...
		docType.setPublicID("-//UBQ//DTD maf-command config XML V1.0//EN");
