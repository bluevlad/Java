 ...
 * @author Rod Johnson
 */
public class NoSuchBundleException extends MafResourceException {
	 ...
	 */
	public NoSuchBundleException(String basename) {
		super("No bundle found under basename '" + basename + ".");
	}
