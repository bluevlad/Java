...
/**
 * <p>Title: Tmax Web Application Framework Utilities</p>
 * <p>Description: Smart Connection</p>
 * <p>Copyright: Copyright Tmax (c) 2003</p>
 * <p>Company: Tmax Soft co., Ltd</p>
...
public class SmartConnection implements Connection {
	...
	private java.util.List statements= null;
	...
	public static void shareConnection() {
		try {
			sharedConnection = new SmartConnection(DriverManager.getConnection(url, username, password));
	...
	public static Connection acquire() {
		...
		Connection c = null;
		try {
			c = new SmartConnection(DriverManager.getConnection(url, username, password));
		} catch (SQLException se) {
			se.printStackTrace();
		} finally {
			return c;
	...
	public static Connection acquire(String dataSourceName) {
		Connection c = null;
		try {
			InitialContext ic = new InitialContext();
			DataSource ds = (DataSource) ic.lookup(dataSourceName);
			c = new SmartConnection(ds.getConnection());
