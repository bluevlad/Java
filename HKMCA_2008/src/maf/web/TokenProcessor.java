...
public class TokenProcessor {
    ...
    public synchronized boolean isTokenValid(
        ...
        String saved = (String) session.getAttribute(MafProperties.TRANSACTION_TOKEN_KEY);
        if (saved == null) {
            return false;
        }
        ...
        String token = request.getParameter(MafProperties.TRANSACTION_TOKEN_KEY);
        if (token == null) {
            return false;
        }
    ...
    public synchronized void resetToken(HttpServletRequest request) {
        ...
        session.removeAttribute(MafProperties.TRANSACTION_TOKEN_KEY);
    }
    ...
    public String getTokenName() {
        return MafProperties.TRANSACTION_TOKEN_KEY;
    }
