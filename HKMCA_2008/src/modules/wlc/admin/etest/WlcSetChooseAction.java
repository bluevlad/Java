...
public class WlcSetChooseAction extends MafAction {
...
/*	
        ...
        param.put("common", ETestCommon.COMMON_ID); 
...
*/	
	public void cmdList(MyHttpServletRequest _req, HttpServletResponse _res) throws MafException {
		...
		result.setAttribute("list", WlcSetManagerDB.getListforChooser(super.oDb, param));
		result.setForward("list");
	}
	...
	public void cmdView(MyHttpServletRequest _req, HttpServletResponse _res) throws MafException {
		...
		result.setAttribute("setitems", WlcSetManagerDB.getSetItems(super.oDb, param));
		result.setAttribute("maxcnt", WlcSetManagerDB.getQueMaxCnt(super.oDb, param));
