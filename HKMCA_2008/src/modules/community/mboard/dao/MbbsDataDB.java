/*
 * 게시판의 Data 관련 처리 작성자 : bluevlad Created on 2004. 9. 23.
 *  
 */
...
/**
 * @author bluevlad Create by 2004. 9. 23.
 *  
 */
public class MbbsDataDB {
     ...
     * @throws SQLException
     */
    public List getList(MBoardManager oMbbs, int v_page, String v_key, String v_srch, String v_status) throws Exception {
        CallableStatement stmt = null;
        ResultSet rs = null;
        ArrayList list = new ArrayList();

        try {
            String sql = "{call MI_BBS.GetList(:v_cur, :v_BID,  :v_page, :v_numrows, :v_status,  :v_key, :v_srch )}";
    ...
    public MbbsDataBean getOne(MBoardManager oMbbs, String c_index)
        ...
        "       get.orgUserid(d.bid, d.c_ref) as orgusn" +
        "  FROM MBBS_DATA d " +
     ...
     * @return
     */
    public String addItem(MBoardManager oMbbs, MbbsDataBean item) throws Exception {
        String c_index = null;
        CallableStatement stmt = null;
